...
})({"2leY7":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "d52f1cb98b42269f74b0a77a3a48f0df";
...
},{}],"5Qp60":[function(require,module,exports) {
"use strict";
...
async function main() {
  ...
  const estimateHands = async () => {
    ...
    playTones(boxesHit, gesture); // ...and so on
...
},{"./styles.css":"BxXxj","tone":"5CgAo","fingerpose":"3zRkE"}],"BxXxj":[function() {},{}],"5CgAo":[function(require,module,exports) {
var define;
!function (t, e) {
  ...
  return function (t) {
    ...
    !function (t, e, s, n) {
        ...
        return a.default(t, [{
          ...
          value: function (t) {
            ...
            if (x(t) || w(t)) {
              ...
              if (-1 === m) this._automationEvents.push(y);else {
      ...
      t.AutomationEventList = A, t.createCancelAndHoldAutomationEvent = function (t) {
        return {
          cancelTime: t,
          type: "cancelAndHold"
        };
      ...
      }, t.createSetValueAutomationEvent = u, t.createSetValueCurveAutomationEvent = l, Object.defineProperty(t, "__esModule", {
        value: !0
      });
    }(e, s(1), s(7), s(8));
  }, function (t, e, s) {
    ...
    const a = new WeakSet(),
      ...
      const n = (t => "playbackRate" in t)(t) ? [t.playbackRate] : V(t) ? Array.from(t.parameters.values()) : (t => "frequency" in t && "gain" in t)(t) ? [t.Q, t.detune, t.frequency, t.gain] : (t => "offset" in t)(t) ? [t.offset] : (t => !("frequency" in t) && "gain" in t)(t) ? [t.gain] : (t => "detune" in t && "frequency" in t)(t) ? [t.detune, t.frequency] : (t => "pan" in t)(t) ? [t.pan] : [];
      ...
      j(t.destination, []);
          ...
          z = t => void 0 === t || "number" == typeof t || "string" == typeof t && ("balanced" === t || "interactive" === t || "playback" === t),
          B = t => "context" in t,
          W = t => B(t[0]),
          U = t => "inputs" in t,
          G = (t, e, s, n) => {
      ...
      return t.connect(e, s, n), [e, s, n];
          ...
          Q = (t, e) => {
      if (!R(t).delete(e)) throw new Error("Missing the expected event listener.");
    },
          Z = (t, e, s, n) => {
      ...
      H(t, [e, s, n], t => t[0] === e && t[1] === s, i);
          ...
          rt = (t, e, [s, n, i], o) => {
      const r = t.get(s);
      void 0 === r ? t.set(s, new Set([[n, e, i]])) : H(r, [n, e, i], t => t[0] === n && t[1] === e, o);
    },
          at = (t, [e, s, n], i) => {
      const o = t.get(e);
      void 0 === o ? t.set(e, new Set([[s, n]])) : H(o, [s, n], t => t[0] === s, i);
    },
          ct = (t, e, s, n) => {
      const i = E(t, e),
            o = K(i, t => t[0] === s && t[1] === n);
      ...
      const {
        ...
        if (a) {
          ...
          const a = ((t, e, s, n) => K(t[n], t => t[0] === e && t[1] === s))(o, t, s, n);

          rt(r, n, a, !1), i || $(t) || Z(h, c, s, n), M(e) && tt(e, o);
        }
      };

      return !!H(a, [e, s, n], t => t[0] === e && t[1] === s && t[2] === n, !0) && (c.add(h), M(t) ? it(o, t, [s, n, h], !0) : rt(r, n, [t, s, h], !0), !0);
    },
          lt = (t, e, s, n) => {
      const {
        activeInputs: i,
        ...
        if (r) {
          ...
          const e = ((t, e, s) => K(t, t => t[0] === e && t[1] === s))(i, t, s);

          at(o, e, !1), n || $(t) || a.disconnect(c, s);
        }
      };

      return !!H(r, [e, s], t => t[0] === e && t[1] === s, !0) && (a.add(c), M(t) ? ot(i, t, [s, c], !0) : at(o, [t, s, c], !0), !0);
    },
          pt = (t, e, s) => {
      ...
      if (null !== o && (Q(t, o), !r || e || $(t) || Z(X(t), X(s), n, i)), M(s)) {
        const {
          activeInputs: t
        } = N(s);
        tt(s, t);
    ...
    const vt = (t, e, s, n, i) => {
      ...
      const l = N(t),
        ...
        return E(s, n);
            ...
            _ = Array.from(t.parameters.keys()).reduce((t, e) => ({ ...t,
        [e]: new Float32Array(128)
      }), {});

      for (let h = 0; h < a; h += 128) {
        if (n.numberOfInputs > 0 && null !== e) for (let t = 0; t < n.numberOfInputs; t += 1) for (let s = 0; s < n.channelCount; s += 1) gt(e, d[t], s, s, h);
        ...
        try {
          ...
          if (null !== u) for (let t = 0, e = 0; t < n.numberOfOutputs; t += 1) {
      ...
      void 0 !== n && n !== t[s] && (t[s] = n);
          ...
          Pt = (t, e) => {
      Nt(t, e, "channelCount"), Nt(t, e, "channelCountMode"), Nt(t, e, "channelInterpretation");
    },
      ...
      t.stop = (e = t.stop, (s = 0) => {
        ...
        e.call(t, s);
          ...
          Wt = (t, e) => null === t ? 512 : Math.max(512, Math.min(16384, Math.pow(2, Math.round(Math.log2(t * e))))),
          Ut = async (t, e) => new t(await (t => new Promise((e, s) => {
      const {
        port1: n,
        port2: i
      } = new MessageChannel();
      ...
      return Pt(s, e), Lt(s, e, "Q"), Lt(s, e, "detune"), Lt(s, e, "frequency"), Lt(s, e, "gain"), Nt(s, e, "type"), s;
    },
          Qt = (t, e) => {
    ...
    const Jt = (t, e, s, n) => t.createScriptProcessor(e, s, n),
      ...
      return Object.defineProperties(s, {
        ...
        target: n
          ...
          me = (ge = new Map(), ve = new WeakMap(), (t, e) => {
      const s = ve.get(t);
      ...
      try {
        const s = e();
        return s instanceof Promise ? (ge.set(t, s), s.catch(() => !1).then(e => (ge.delete(t), ve.set(t, e), e))) : (ve.set(t, s), s);
      } catch {
        return ve.set(t, !1), !1;
      }
    });
    ...
    const ye = "undefined" == typeof window ? null : window,
      ...
      return Nt(s, e, "fftSize"), Nt(s, e, "maxDecibels"), Nt(s, e, "minDecibels"), Nt(s, e, "smoothingTimeConstant"), we(jt, () => jt(s)) || (t => {
    ...
    const Re = (t => null === t ? null : t.hasOwnProperty("OfflineAudioContext") ? t.OfflineAudioContext : t.hasOwnProperty("webkitOfflineAudioContext") ? t.webkitOfflineAudioContext : null)(ye),
    ...
    const Ie = new WeakMap(),
      ...
      addEventListener(t, e, s) {
        if (null !== e) {
          ...
          void 0 === n && (n = Ne(this, e), "function" == typeof e && this._listeners.set(e, n)), this._nativeEventTarget.addEventListener(t, n, s);
        }
      }
    ...
    const Pe = (t => null === t ? null : t.hasOwnProperty("AudioContext") ? t.AudioContext : t.hasOwnProperty("webkitAudioContext") ? t.webkitAudioContext : null)(ye),
          je = (Le = Pe, t => null !== Le && t instanceof Le);

    var Le;

    const ze = (t => e => null !== t && "function" == typeof t.AudioNode && e instanceof t.AudioNode)(ye),
          Be = (t => e => null !== t && "function" == typeof t.AudioParam && e instanceof t.AudioParam)(ye),
          We = ((t, e, s, n, i, o, r, a, c, u, l, p, f, _) => class extends c {
      constructor(s, n, i, o) {
        ...
        l(r) && !0 !== e(et, () => et(r)) && (t => {
          ...
          t.connect = (s = t.connect.bind(t), (t, n = 0, i = 0) => {
            ...
            for (const [s, n] of e) n.forEach(e => {
              nt(s) ? t.connect(s, e.output, e.input) : t.connect(s, e.output);
            });
          });
        })(i), h.set(this, i), d.set(this, new Set()), "closed" !== s.state && n && q(this), t(this, o, i);
      }
      ...
      connect(t, e = 0, r = 0) {
        if (e < 0 || e >= this._nativeAudioNode.numberOfOutputs) throw n();
        ...
        if (B(t)) {
          ...
          try {
            const s = G(this._nativeAudioNode, n, e, r),
                  i = J(this);
            (h || i) && this._nativeAudioNode.disconnect(...s), "closed" !== this.context.state && !i && J(t) && q(t);
          } catch (t) {
        ...
        try {
          this._nativeAudioNode.connect(l, e), (h || J(this)) && this._nativeAudioNode.disconnect(l, e);
        } catch (t) {
          if (12 === t.code) throw i();
          throw t;
        }
      ...
      disconnect(t, e, s) {
        ...
        if (void 0 === t) o = ((t, e) => {
          ...
          for (const i of s.outputs) W(i) ? dt(t, e, ...i) : ft(t, e, ...i), n.push(i[0]);

          return s.outputs.clear(), n;
        })(this, h);else if ("number" == typeof t) {
          ...
          o = ((t, e, s) => {
            ...
            for (const o of n.outputs) o[1] === s && (W(o) ? dt(t, e, ...o) : ft(t, e, ...o), i.push(o[0]), n.outputs.delete(o));

            return i;
          })(this, h, t);
        } else {
          if (void 0 !== e && (e < 0 || e >= this.numberOfOutputs)) throw n();
          if (B(t) && void 0 !== s && (s < 0 || s >= t.numberOfInputs)) throw n();
          if (o = ((t, e, s, n, i) => {
            const o = N(t);
            return Array.from(o.outputs).filter(t => !(t[0] !== s || void 0 !== n && t[1] !== n || void 0 !== i && t[2] !== i)).map(s => (W(s) ? dt(t, e, ...s) : ft(t, e, ...s), o.outputs.delete(s), s[0]));
          })(this, h, t, e, s), 0 === o.length) throw i();
        }
    ...
    })(f, Z, N, X, Y, M), k, Et, Kt, ((t, e, s, n, i, o, r, a) => (c, h) => {
      const u = e.get(c);
    ...
    })(G, f, N, X, Y, Me, M, qe), ((t, e, s) => function n(i, o) {
      const r = B(o) ? o : s(t, o);
    ...
    })(Ie, N, E), Ve, Me, je, ze, Be, qe);

    var Ue;

    const Ge = ((t, e, s, n, i, o) => class extends t {
      constructor(t, s) {
        const r = i(t),
              a = { ...b,
          ...s
      ...
      getFloatTimeDomainData(t) {
        this._nativeAnalyserNode.getFloatTimeDomainData(t);
          ...
          Qe = new WeakSet(),
          Ze = (t => null === t ? null : t.hasOwnProperty("AudioBuffer") ? t.AudioBuffer : null)(ye),
    ...
    const He = ((t, e) => s => {
      ...
      return class h {
        constructor(h) {
          ...
          return "function" != typeof d.copyFromChannel ? (r(d), C(d)) : e(S, () => S(d)) || a(d), t.add(d), d;
        }
    ...
    const ss = ((t, e, s) => async (n, i, o, r) => {
      ...
      return Pt(d, p), Lt(d, p, "playbackRate"), Nt(d, p, "buffer"), Nt(d, p, "loop"), Nt(d, p, "loopEnd"), Nt(d, p, "loopStart"), e(s, () => s(l)) || (t => {
        t.start = (e => {
          let s = !1;
          return (n = 0, i = 0, o) => {
            if (s) throw Mt();
      ...
      })(d), e(n, () => n(l)) || c(d), e(i, () => i(l)) || h(d, l), e(o, () => o(l)) || zt(d), e(r, () => r(l)) || u(d, l), e(a, () => a(l)) || Bt(d), t(l, d), d;
    })(ts, me, t => {
      ...
      null === t.buffer && (t.buffer = s), os(t, "buffer", e => () => {
        const n = e.call(t);
        return n === s ? null : n;
    ...
    const rs = ((t, e) => (s, n, i, o) => (t(n).replay(i), e(n, s, i, o)))((t => e => {
      const s = t(e);
      ...
      return {
        ...
        render(c, h, u) {
          ...
          cs = ((t, e, s, n, i, o, a, c, h, u, l, p) => (d, f, _, m = null, g = null) => {
      const v = new r.AutomationEventList(_.defaultValue),
        ...
        cancelAndHoldAtTime(t) {
          if ("function" == typeof _.cancelAndHoldAtTime) null === y && v.flush(d.context.currentTime), v.add(i(t)), _.cancelAndHoldAtTime(t);else {
    ...
    }), r.createCancelAndHoldAutomationEvent, r.createCancelScheduledValuesAutomationEvent, r.createExponentialRampToValueAutomationEvent, r.createLinearRampToValueAutomationEvent, r.createSetTargetAutomationEvent, r.createSetValueAutomationEvent, r.createSetValueCurveAutomationEvent, Pe);

    var hs;

    const us = ((t, e, s, n, i, o, r, a) => class extends t {
      constructor(t, n) {
        const a = o(t),
              c = { ...I,
          ...n
              ...
              u = r(a),
              l = u ? e() : null;
        super(t, !1, h, l), this._audioBufferSourceNodeRenderer = l, this._isBufferNullified = !1, this._isBufferSet = null !== c.buffer, this._nativeAudioBufferSourceNode = h, this._onended = null, this._playbackRate = s(this, u, h.playbackRate, O, D);
      }
      ...
      start(t = 0, e = 0, s) {
        if (this._nativeAudioBufferSourceNode.start(t, e, s), null !== this._audioBufferSourceNodeRenderer && (this._audioBufferSourceNodeRenderer.start = void 0 === s ? [t, e] : [t, e, s]), "closed" !== this.context.state) {
          ...
          const t = () => {
            this._nativeAudioBufferSourceNode.removeEventListener("ended", t), setTimeout(() => {
              M(this) && F(this);
            }, 1e3);
          };
      ...
      stop(t = 0) {
        this._nativeAudioBufferSourceNode.stop(t), null !== this._audioBufferSourceNodeRenderer && (this._audioBufferSourceNodeRenderer.stop = t);
          ...
          ls = ((t, e, s, n, i, o, r, a) => class extends t {
      constructor(t, s) {
        const n = o(t),
              c = r(n),
              h = i(n, s, c);
      ...
      return {
        render(r, a, c) {
          ...
          ds = (fs = We, _s = cs, ms = ps, gs = Et, vs = Gt, ys = Me, xs = qe, class extends fs {
      constructor(t, e) {
        const s = ys(t),
              n = { ...wt,
          ...e
              ...
              i = vs(s, n),
              o = xs(s);
        super(t, !1, i, o ? ms() : null), this._Q = _s(this, o, i.Q, O, D), this._detune = _s(this, o, i.detune, 1200 * Math.log2(O), -1200 * Math.log2(O)), this._frequency = _s(this, o, i.frequency, t.sampleRate / 2, 0), this._gain = _s(this, o, i.gain, 40 * Math.log10(O), D), this._nativeBiquadFilterNode = i;
      }
      ...
      getFrequencyResponse(t, e, s) {
        if (this._nativeBiquadFilterNode.getFrequencyResponse(t, e, s), t.length !== e.length || e.length !== s.length) throw gs();
      }
    ...
    const ws = ((t, e) => (s, n, i) => {
      ...
      return s.connect = (r = s.connect, (i, a = 0, c = 0) => {
        ...
        const c = o.size > 0;
        if (void 0 === t) a.apply(s), o.clear();else if ("number" == typeof t) {
          a.call(s, t);
    ...
    const ks = ((t, e) => (s, n) => {
      ...
      return null !== t && "webkitAudioContext" === t.name && e(s, i), Pt(i, n), i;
    })(Pe, bs),
          Cs = ((t, e, s, n, i) => class extends t {
      constructor(t, o) {
        const r = n(t),
              a = { ...bt,
          ...o
      ...
      return {
        render(i, o, r) {
          ...
          As = ((t, e, s, n, i, o) => class extends t {
      constructor(t, r) {
        const a = n(t),
              c = o({ ...Tt,
          ...r
      ...
      return t(i, c), n(Zt(l, h), () => c.connect(h), () => c.disconnect(h));
    })(ts, is, Yt, ws),
          Os = ((t, e, s, n, i) => (o, r) => {
      if (void 0 === o.createConstantSource) return s(o, r);
      const a = o.createConstantSource();
      return Pt(a, r), Lt(a, r, "offset"), e(n, () => n(o)) || zt(a), e(i, () => i(o)) || Bt(a), t(o, a), a;
    })(ts, me, Ds, he, le),
          Ms = ((t, e, s, n, i, o, r) => class extends t {
      constructor(t, r) {
        const a = i(t),
              c = { ...St,
          ...r
              ...
              u = o(a),
              l = u ? s() : null;
        super(t, !1, h, l), this._constantSourceNodeRenderer = l, this._nativeConstantSourceNode = h, this._offset = e(this, u, h.offset, O, D), this._onended = null;
      }
      ...
      start(t = 0) {
        if (this._nativeConstantSourceNode.start(t), null !== this._constantSourceNodeRenderer && (this._constantSourceNodeRenderer.start = t), "closed" !== this.context.state) {
          ...
          const t = () => {
            this._nativeConstantSourceNode.removeEventListener("ended", t), setTimeout(() => {
              M(this) && F(this);
            }, 1e3);
          };
    ...
    })(ns, Os, X, rs, ke), Os, Me, qe, _e),
          Es = ((t, e) => (s, n) => {
      const i = s.createConvolver();
      if (Pt(i, n), n.disableNormalization === i.normalize && (i.normalize = !n.disableNormalization), Nt(i, n, "buffer"), n.channelCount > 2) throw t();
      ...
      constructor(t, o) {
        const r = n(t),
          ...
          ...o
              ...
              c = s(r, a);
        super(t, !1, c, i(r) ? e() : null), this._isBufferNullified = !1, this._nativeConvolverNode = c;
      }
      ...
      return {
        render(i, o, r) {
          ...
          return void 0 !== a ? Promise.resolve(a) : (async (i, o, r) => {
            ...
            return n.set(o, a), U(a) ? await s(i, o, a.inputs[0], r) : await s(i, o, a, r), a;
          })(i, o, r);
        }
      ...
      constructor(t, r) {
        const a = i(t),
          ...
          ...r
              ...
              h = n(a, c),
              u = o(a);
        super(t, !1, h, u ? s(c.maxDelayTime) : null), this._delayTime = e(this, u, h.delayTime);
      }
    ...
    })(ns, Xt, X, rs, ke), Xt, Me, qe),
          Fs = (Is = Kt, (t, e) => {
      const s = t.createDynamicsCompressor();
      if (Pt(s, e), e.channelCount > 2) throw Is();
      if ("max" === e.channelCountMode) throw Is();
      return Lt(s, e, "attack"), Lt(s, e, "knee"), Lt(s, e, "ratio"), Lt(s, e, "release"), Lt(s, e, "threshold"), s;
    });

    var Is;

    const Vs = ((t, e, s, n, i, o, r) => class extends t {
      constructor(t, i) {
        const a = o(t),
              c = { ...Dt,
          ...i
              ...
              h = n(a, c),
              u = r(a);
        super(t, !1, h, u ? s() : null), this._attack = e(this, u, h.attack), this._knee = e(this, u, h.knee), this._nativeDynamicsCompressorNode = h, this._ratio = e(this, u, h.ratio), this._release = e(this, u, h.release), this._threshold = e(this, u, h.threshold);
      }
      ...
      constructor(t, r) {
        const a = i(t),
          ...
          ...r
              ...
              h = n(a, c),
              u = o(a);
        super(t, !1, h, u ? s() : null), this._gain = e(this, u, h.gain, O, D);
      }
      ...
      return Zt({
        ...
        removeEventListener: (...t) => g.removeEventListener(t[0], t[1], t[2])
          ...
          js = ((t, e, s, n) => i => t(It, () => It(i)) ? Promise.resolve(t(n, n)).then(t => {
      if (!t) {
        const t = s(i, 512, 0, 1);
        i.oncomplete = () => {
            ...
            c = (async () => {
              ...
              return ((t, e, s, n) => {
                ...
                for (let e = 0; e < p; e += 1) {
                  ...
                  h.fill(0), u.fill(0), qt(i, r, o, a, c, h, u, 0, 32, s, n);
                }
    ...
    const Bs = ((t, e, s, n, i) => class extends t {
      constructor(t, o) {
        const r = n(t),
              a = i(r),
              c = { ...Rt,
        ...
        super(t, !1, h, a ? s(c.feedback, c.feedforward) : null), (t => {
          var e;
          t.getFrequencyResponse = (e = t.getFrequencyResponse, (s, n, i) => {
            if (s.length !== n.length || n.length !== i.length) throw Et();
            return e.call(t, s, n, i);
          });
        })(h), this._nativeIIRFilterNode = h;
      }
      ...
      return {
        ...
        get upZ() {
          ...
          Us = new WeakMap(),
          Gs = ((t, e, s, n, i, o) => class extends s {
      constructor(s, o) {
      ...
      return Pt(c, a), Lt(c, a, "detune"), Lt(c, a, "frequency"), void 0 !== a.periodicWave ? c.setPeriodicWave(a.periodicWave) : Nt(c, a, "type"), e(s, () => s(r)) || zt(c), e(n, () => n(r)) || o(c, r), e(i, () => i(r)) || Bt(c), t(r, c), c;
    })(ts, me, he, ue, le, fe),
          Zs = ((t, e, s, n, i, o, r) => class extends t {
      constructor(t, r) {
        const a = i(t),
              c = { ...ee,
          ...r
      ...
      start(t = 0) {
        if (this._nativeOscillatorNode.start(t), null !== this._oscillatorNodeRenderer && (this._oscillatorNodeRenderer.start = t), "closed" !== this.context.state) {
          ...
          const t = () => {
            this._nativeOscillatorNode.removeEventListener("ended", t), setTimeout(() => {
              M(this) && F(this);
            }, 1e3);
          };
      ...
      return s.buffer = n, s.loop = !0, s.connect(e), s.start(), () => {
    ...
    const Hs = ((t, e, s, n, i) => (o, {
      ...
      const v = {
        ...
        set curve(s) {
          ...
          if (null === s) h.curve = s, u.curve = s;else {
            const t = s.length,
      ...
      return c(Zt(j, k), () => {
        D.connect(k), t(D, V, 0, 0), V.connect(O).connect(A, 0, 0), V.connect(M).connect(A, 0, 1), V.connect(E).connect(A, 0, 2), V.connect(R).connect(A, 0, 3), V.connect(q).connect(A, 0, 4), V.connect(F).connect(A, 0, 5), A.connect(I).connect(h.destination);
      }, () => {
      ...
      return void 0 === s.orientationX ? tn(t, e) : (Pt(s, e), Lt(s, e, "orientationX"), Lt(s, e, "orientationY"), Lt(s, e, "orientationZ"), Lt(s, e, "positionX"), Lt(s, e, "positionY"), Lt(s, e, "positionZ"), Nt(s, e, "coneInnerAngle"), Nt(s, e, "coneOuterAngle"), Nt(s, e, "coneOuterGain"), Nt(s, e, "distanceModel"), Nt(s, e, "maxDistance"), Nt(s, e, "panningModel"), Nt(s, e, "refDistance"), Nt(s, e, "rolloffFactor"), s);
    });

    var tn;

    const en = ((t, e, s, n, i, o) => class extends t {
      constructor(t, r) {
        const a = i(t),
              c = { ...se,
          ...r
          ...
          return void 0 !== _ ? Promise.resolve(_) : (async (p, d, f) => {
            ...
            if (u.set(d, null === _ ? m : _), null !== _) {
              if (null === l) {
                ...
                n.connect(t.destination), l = (async () => {
              ...
              for (let e = 128; e < t.length; e += 128) {
                ...
                if (t.some((t, e) => t !== m[e]) || s.some((t, e) => t !== y[e])) {
                  ...
                  x.gain.setValueAtTime(0, r), x = n(d, { ...g,
                    gain: 0
                  }), w = i(d, { ...v,
                    orientationX: m[0],
                    orientationY: m[1],
      ...
      const r = new Float32Array([1, 1]),
        ...
        if (1 === o) return ((t, e, i, o) => {
          ...
          return {
            connectGraph() {
              e.connect(p), e.connect(f.inputs[0]), e.connect(_), f.connect(i), i.connect(d.inputs[0]), i.connect(m.inputs[0]), d.connect(p.gain), m.connect(_.gain), p.connect(o, 0, 0), _.connect(o, 0, 1);
            },

            disconnectGraph() {
              e.disconnect(p), e.disconnect(f.inputs[0]), e.disconnect(_), f.disconnect(i), i.disconnect(d.inputs[0]), i.disconnect(m.inputs[0]), d.disconnect(p.gain), m.disconnect(_.gain), p.disconnect(o, 0, 0), _.disconnect(o, 0, 1);
            }
        ...
        if (2 === o) return ((t, i, o, u) => {
          ...
          return {
            ...
            disconnectGraph() {
              i.disconnect(m), i.disconnect(w.inputs[0]), m.disconnect(g, 0), m.disconnect(y, 0), m.disconnect(b, 1), m.disconnect(S, 1), w.disconnect(o), o.disconnect(v.inputs[0]), o.disconnect(x.inputs[0]), o.disconnect(T.inputs[0]), o.disconnect(k.inputs[0]), v.disconnect(g.gain), x.disconnect(y.gain), T.disconnect(b.gain), k.disconnect(S.gain), g.disconnect(u, 0, 0), b.disconnect(u, 0, 0), y.disconnect(u, 0, 1), S.disconnect(u, 0, 1);
            }
      ...
      return (e, {
        ...
        return o(Zt(_, h), () => {
          ...
          on = ((t, e, s, n, i, o) => class extends t {
      constructor(t, r) {
        const a = i(t),
              c = { ...ie,
          ...r
      ...
      return {
        render(r, a, c) {
          ...
          return void 0 !== h ? Promise.resolve(h) : (async (r, a, c) => {
            ...
            return o.set(a, h), u ? await t(a, r.pan, h.pan, c) : await n(a, r.pan, h.pan, c), U(h) ? await i(r, a, h.inputs[0], c) : await i(r, a, h, c), h;
          })(r, a, c);
        }
      ...
      return {
        render(i, o, r) {
          ...
          an = ((t, e, s, n, i, o) => class extends t {
      constructor(t, e) {
        const r = i(t),
              a = { ...re,
          ...e
              ...
              c = s(r, a);
        super(t, !0, c, o(r) ? n() : null), this._isCurveNullified = !1, this._nativeWaveShaperNode = c;
      }
      ...
      return n = new e(1, 1, 8e3), t.set(s, n), n;
          ...
          pn = (t => null === t ? null : t.hasOwnProperty("AudioWorkletNode") ? t.AudioWorkletNode : null)(ye),
          dn = cn ? ((t, e, s, n, i, o, r, a, c, h, u, l) => (p, d, f = {
      credentials: "omit"
    }) => {
      const m = o(p),
            g = new URL(d, l.location.href).toString();
      if (void 0 !== m.audioWorklet) return Promise.all([i(d), Promise.resolve(t(u, u))]).then(([t, e]) => {
        const [s, n] = y(t, g),
              i = e ? n : n.replace(/\s+extends\s+AudioWorkletProcessor\s*{/, " extends (class extends AudioWorkletProcessor {__b=new WeakSet();constructor(){super();(p=>p.postMessage=(q=>(m,t)=>q.call(p,m,t?t.filter(u=>!this.__b.has(u)):t))(p.postMessage))(this.port)}}){"),
              o = new Blob([`${s};(registerProcessor=>{${i}\n})((n,p)=>registerProcessor(n,class extends p{${e ? "" : "__c = (a) => a.forEach(e=>this.__b.add(e.buffer));"}process(i,o,p){${e ? "" : "i.forEach(this.__c);o.forEach(this.__c);this.__c(Object.values(p));"}return super.process(i.map(j=>j.some(k=>k.length===0)?[]:j),o,p)}}))`], {
          type: "application/javascript; charset=utf-8"
        }),
              c = URL.createObjectURL(o);
        return m.audioWorklet.addModule(c, f).then(() => {
          if (a(m)) return;
      ...
      return void 0 === b ? c.set(p, new Map([[d, T]])) : b.set(d, T), T.then(() => {
        const t = h.get(p);
      ...
      throw t();
    })(() => new DOMException("", "AbortError")), Me, ln, qe, new WeakMap(), new WeakMap(), ((t, e) => async () => {
      if (null === t) return !0;
      if (null === e) return !1;
      ...
      return o && !r;
          ...
          _n = ((t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _, m, g, v, y) => class extends f {
      constructor(e, s) {
      ...
      decodeAudioData(t, e, s) {
        return h(this._nativeContext, t).then(t => ("function" == typeof e && e(t), t)).catch(t => {
          throw "function" == typeof s && s(t), t;
        });
      }

    })(dn, Ge, Je, us, ds, Cs, As, Ms, Rs, ((t, e, s, n, i, o, r, a, c, h, u) => (l, p) => {
      const d = r(l) ? l : o(l);
      ...
      return e(c, () => c(d)) ? d.decodeAudioData(p).then(s => (e(a, () => a(s)) || u(s), t.add(s), s)) : new Promise((e, s) => {
        ...
        try {
          d.decodeAudioData(p, s => {
            "function" != typeof s.copyFromChannel && (h(s), C(s)), t.add(s), i(), e(s);
          }, t => {
            o(null === t ? n() : t);
          });
        } catch (t) {
    ...
    })(Qe, me, () => new DOMException("", "DataCloneError"), () => new DOMException("", "EncodingError"), new WeakSet(), Me, fn, S, It, He, $e), qs, Vs, Ns, Bs, Gs, Zs, en, sn, on, an),
          mn = ((t, e, s, n) => class extends t {
      constructor(t, i) {
        const o = s(t),
              r = e(o, i);
      ...
      return Pt(s, e), 1 === s.numberOfOutputs && Object.defineProperty(s, "numberOfOutputs", {
        get: () => 0
      }), s;
    }, Me, qe),
          vn = ((t, e, s, n) => class extends t {
      constructor(t, i) {
        const o = s(t),
              r = e(o, i);
        if (n(o)) throw new TypeError();
      ...
      return o;
          ...
          xn = ((t, e, s, n, i, o, r, a, c) => class extends t {
      constructor(t = {}) {
        if (null === c) throw new Error("Missing the native AudioContext constructor.");
        const e = new c(t);
        if (null === e) throw n();
        if (!z(t.latencyHint)) throw new TypeError(`The provided value '${t.latencyHint}' is not a valid enum value of type AudioContextLatencyCategory.`);
      ...
      close() {
        return "closed" === this.state ? this._nativeAudioContext.close().then(() => {
          ...
          null !== this._nativeGainNode && null !== this._nativeOscillatorNode && (this._nativeOscillatorNode.stop(), this._nativeGainNode.disconnect(), this._nativeOscillatorNode.disconnect()), L(this);
        }));
      }
    ...
    const kn = (t => (e, s, n = 0, i = 0) => {
      ...
      t(e).delete(s);
          ...
          An = (t => (e, s, n, i = 0) => void 0 === s ? e.forEach(t => t.disconnect()) : "number" == typeof s ? At(t, e, s).disconnect() : nt(s) ? void 0 === n ? e.forEach(t => t.disconnect(s)) : void 0 === i ? At(t, e, n).disconnect(s, 0) : At(t, e, n).disconnect(s, 0, i) : void 0 === n ? e.forEach(t => t.disconnect(s)) : At(t, e, n).disconnect(s, 0))(k),
          Dn = new WeakMap(),
          On = ((t, e) => s => e(t, s))(Dn, E),
      ...
      const k = [];
      if (void 0 !== _.parameterDescriptors) for (const {
        defaultValue: t,
        maxValue: e,
        minValue: s,
        name: n
      ...
      for (let t = 0; t < g.numberOfOutputs; t += 1) R.push(n(d, {
        channelCount: 1,
        channelCountMode: "explicit",
        channelInterpretation: "speakers",
        numberOfInputs: v[t]
      ...
      const q = new _t(void 0 === _.parameterDescriptors ? [] : _.parameterDescriptors.map(({
        name: t
      }, e) => {
        const s = k[e];
      ...
      const V = 0 === g.numberOfOutputs ? [M] : R,
        ...
        set onprocessorerror(t) {
          "function" == typeof I && N.removeEventListener("processorerror", I), I = "function" == typeof t ? t : null, "function" == typeof I && N.addEventListener("processorerror", I);
        },
      ...
      const W = yt(g.numberOfInputs, g.channelCount),
            ...
            G = void 0 === _.parameterDescriptors ? [] : _.parameterDescriptors.reduce((t, {
        name: e
      }) => ({ ...t,
        [e]: new Float32Array(128)
      }), {});
      ...
      M.onaudioprocess = ({
        ...
        if (null !== B) for (let s = 0; s < A; s += 128) {
          for (let e = 0; e < g.numberOfInputs; e += 1) for (let n = 0; n < g.channelCount; n += 1) gt(t, W[e], n, n, s);

          void 0 !== _.parameterDescriptors && _.parameterDescriptors.forEach(({
            name: e
          }, n) => {
            gt(t, G, e, y + n, s);
          });
          ...
          try {
            const t = l(N),
                  ...
                  i = u(d.currentTime + s / d.sampleRate, d.sampleRate, () => B.process(n, U, G));
            Q = i;
          ...
          if (!Q) {
            for (let t = 0; t < g.numberOfInputs; t += 1) {
              ...
              for (let e = 0; e < g.channelCount; e += 1) S[s].disconnect(C, e, t * g.channelCount + e);
            }
      ...
      return {
        render(w, b, S) {
          a(b, w);
          const k = y.get(b);
          return void 0 !== k ? Promise.resolve(k) : (async (a, w, b) => {
            let S = u(a),
                k = null;
            const C = T(S, w),
            ...
            if (null === l) {
              ...
              h.connect = e.bind(null, o), h.disconnect = c.bind(null, o), k = [s, o, h];
            } else C || (S = new l(w, m));
            ...
            if (y.set(w, null === k ? S : k[2]), null !== k) {
              ...
              for (let t = 0, e = 0; t < a.numberOfOutputs; t += 1) {
                ...
                for (let n = 0; n < A[t]; n += 1) c.connect(s, e + n, n);
            ...
            if (C) for (const [e, s] of a.parameters.entries()) await t(w, s, S.parameters.get(e), b);else for (const [t, e] of a.parameters.entries()) await d(w, e, S.parameters.get(t), b);
      ...
      t.set(e, s);
          ...
          In = cn ? ((t, e, s, n, i, o, r, a, c, h, u, l, p) => class extends e {
      constructor(e, p, d) {
        var f;
        ...
        b.parameters.forEach((t, e) => {
          const n = s(this, g, t);
          T.push([e, n]);
        }), this._nativeAudioWorkletNode = b, this._onprocessorerror = null, this._parameters = new _t(T), g && t(m, this);
        const {
          activeInputs: S
        } = o(this);
        l(b, S);
    ...
    })(Tn, We, cs, Rn, En, N, qn, Me, qe, pn, t => ({ ...t,
      outputChannelCount: void 0 !== t.outputChannelCount ? t.outputChannelCount : 1 === t.numberOfInputs && 1 === t.numberOfOutputs ? [t.channelCount] : Array.from({
        length: t.numberOfOutputs
          ...
          Vn = (((t, e, s, n, i) => {})(Mt, Kt, oe, Gs, Pe), ((t, e) => (s, n, i) => {
      if (null === e) throw new Error("Missing the native OfflineAudioContext constructor.");
      ...
      try {
        ...
        throw e;
          ...
          Nn = ((t, e, s, n, i, o, r, a) => {
      const c = [];
      return (h, u) => s(h).render(h, u, c).then(() => Promise.all(Array.from(n(u)).map(t => s(t).render(t, u, c)))).then(() => i(u)).then(s => ("function" != typeof s.copyFromChannel ? (r(s), C(s)) : e(o, () => o(s)) || a(s), t.add(s), s));
    })(Qe, me, Te, wn, js, S, He, $e),
          Pn = (((t, e, s, n, i) => {})(me, Mt, Vn, Gs, Nn), ((t, e, s, n, i) => class extends t {
      constructor(t, s, i) {
        let o;
        ...
        const {
          ...
          ...o
              ...
              h = n(a, r, c);
        e(It, () => It(h)) || h.addEventListener("statechange", (() => {
          let t = 0;
    ...
    const Qn = ((t, e) => s => {
      ...
      return e(n) || e(s);
          ...
          Zn = () => (async (t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => {
      ...
      return !0;
    })(Re), pe, (t => () => null !== t && t.hasOwnProperty("isSecureContext"))(ye), (t => () => {
      if (null === t) return !1;
      const e = new t();
    ...
    function Hn(t) {
      t.isOffline || "running" === t.state || ti('The AudioContext is "suspended". Invoke Tone.start() from a user action to start the audio.');
    }
    ...
    const ui = "object" == typeof self ? self : null,
          li = ui && (ui.hasOwnProperty("AudioContext") || ui.hasOwnProperty("webkitAudioContext"));
    ...
    function wi(t, ...e) {
      ...
      const s = e.shift();
      if (oi(t) && oi(s)) for (const e in s) xi(e, s[e]) ? t[e] = s[e] : oi(s[e]) ? (t[e] || Object.assign(t, {
        [e]: {}
      }), wi(t[e], s[e])) : Object.assign(t, {
        [e]: s[e]
      });
      return wi(t, ...e);
    }
    ...
    function bi(t, e, s = [], n) {
      ...
      if (oi(o[0]) && n && !Reflect.has(o[0], n)) {
        Object.keys(o[0]).some(e => Reflect.has(t, e)) || (wi(i, {
          [n]: o[0]
        }), s.splice(s.indexOf(n), 1), o.shift());
      }

      if (1 === o.length && oi(o[0])) wi(i, o[0]);else for (let t = 0; t < s.length; t++) si(o[t]) && (i[s[t]] = o[t]);
      return wi(t, i);
    }
    ...
    class ki {
      ...
      log(...t) {
        (this.debug || ui && this.toString() === ui.TONE_DEBUG_CLASS) && Kn(this, ...t);
      }
    ...
    class Ei extends ki {
      ...
      add(t) {
        if (Xn(Reflect.has(t, "time"), "Timeline: events must have a time attribute"), t.time = t.time.valueOf(), this.increasing && this.length) {
          const e = this._timeline[this.length - 1];
          Xn(Ai(t.time, e.time), "The time must be greater than or equal to the last scheduled time"), this._timeline.push(t);
        } else {
        ...
        if (this._timeline.length > 1) {
          ...
          if (e >= 0) {
            if (Oi(this._timeline[e].time, t)) {
              for (let s = e; s >= 0 && Oi(this._timeline[s].time, t); s--) e = s;

              this._timeline = this._timeline.slice(0, e);
            } else this._timeline = this._timeline.slice(0, e + 1);
          } else this._timeline = [];
        } else 1 === this._timeline.length && Ai(this._timeline[0].time, t) && (this._timeline = []);
    ...
    class Vi extends ki {
      ...
      on(t, e) {
        return t.split(/\W+/).forEach(t => {
          ei(this._events) && (this._events = {}), this._events.hasOwnProperty(t) || (this._events[t] = []), this._events[t].push(e);
        }), this;
      }
      ...
      off(t, e) {
        return t.split(/\W+/).forEach(s => {
          if (ei(this._events) && (this._events = {}), this._events.hasOwnProperty(t)) if (ei(e)) this._events[t] = [];else {
    ...
    class Pi extends Ni {
      constructor() {
        super(), this.name = "Context", this._constants = new Map(), this._timeouts = new Ei(), this._timeoutIds = 0, this._initialized = !1, this.isOffline = !1, this._workletModules = new Map();
        ...
        }), this._ticker = new fi(this.emit.bind(this, "tick"), t.clockSource, t.updateInterval), this.on("tick", this._timeoutLoop.bind(this)), this._context.onstatechange = () => {
      ...
      initialize() {
        var t;
        return this._initialized || (t = this, Ri.forEach(e => e(t)), this._initialized = !0), this;
      }
      ...
      set listener(t) {
        Xn(!this._initialized, "The listener cannot be set after initialization."), this._listener = t;
      }
      ...
      set transport(t) {
        Xn(!this._initialized, "The transport cannot be set after initialization."), this._transport = t;
      }
      ...
      set draw(t) {
        Xn(!this._initialized, "Draw cannot be set after initialization."), this._draw = t;
      }
      ...
      set destination(t) {
        Xn(!this._initialized, "The destination cannot be set after initialization."), this._destination = t;
      }

      createAudioWorkletNode(t, e) {
        return function (t, e, s) {
          return Xn(si(In), "This node only works in a secure context (https or localhost)"), new In(t, e, s);
        }
        /*! *****************************************************************************
      ...
      addAudioWorkletModule(t, e) {
        return di(this, void 0, void 0, function* () {
          Xn(si(this.rawContext.audioWorklet), "AudioWorkletNode is only available in a secure context (https or localhost)"), this._workletModules.has(e) || this._workletModules.set(e, this.rawContext.audioWorklet.addModule(t)), yield this._workletModules.get(e);
        });
      }
      ...
      _setLatencyHint(t) {
        let e = 0;
        if (this._latencyHint = t, ci(t)) switch (t) {
          case "interactive":
            e = .1;
            break;
      ...
      resume() {
        return "suspended" === this._context.state && vi(this._context) ? this._context.resume() : Promise.resolve();
      }

      close() {
        return di(this, void 0, void 0, function* () {
          var t;
          vi(this._context) && (yield this._context.close()), this._initialized && (t = this, Fi.forEach(e => e(t)));
        });
      }
    ...
    function ji(t, e) {
      ai(e) ? e.forEach(e => ji(t, e)) : Object.defineProperty(t, e, {
        enumerable: !0,
        writable: !1
      });
    }
    ...
    function Li(t, e) {
      ai(e) ? e.forEach(e => Li(t, e)) : Object.defineProperty(t, e, {
        writable: !0
      });
    }
    ...
    class Bi extends ki {
      constructor() {
        ...
        const t = bi(Bi.getDefaults(), arguments, ["url", "onload", "onerror"]);
        this.reverse = t.reverse, this.onload = t.onload, t.url && yi(t.url) || t.url instanceof Bi ? this.set(t.url) : ci(t.url) && this.load(t.url).catch(t.onerror);
      }
      ...
      set(t) {
        return t instanceof Bi ? t.loaded ? this._buffer = t.get() : t.onload = () => {
      ...
      toMono(t) {
        if (ii(t)) this.fromArray(this.toArray(t));else {
      ...
      static load(t) {
        return di(this, void 0, void 0, function* () {
          ...
          if (e) {
            ...
            for (const t of s) if (Bi.supportsType(t)) {
              n = t;
              break;
            }
          ...
          const s = "" === Bi.baseUrl || Bi.baseUrl.endsWith("/") ? Bi.baseUrl : Bi.baseUrl + "/",
                n = yield fetch(s + t);
      ...
      static loaded() {
        return di(this, void 0, void 0, function* () {
          for (yield Promise.resolve(); Bi.downloads.length;) yield Bi.downloads[0];
        });
      }
    ...
    class Wi extends Pi {
      constructor() {
        ...
        super({
          clockSource: "offline",
          context: gi(arguments[0]) ? arguments[0] : (t = arguments[0], e = arguments[1] * arguments[2], s = arguments[2], new Pn(t, e, s)),
          lookAhead: 0,
          updateInterval: gi(arguments[0]) ? 128 / arguments[0].sampleRate : 128 / arguments[2]
        }), this.name = "OfflineContext", this._currentTime = 0, this.isOffline = !0, this._duration = gi(arguments[0]) ? arguments[0].length / arguments[0].sampleRate : arguments[1];
      }
    ...
    class so extends ki {
      ...
      valueOf() {
        if (this._val instanceof so && this.fromType(this._val), ei(this._val)) return this._noArg();
        ...
        if (ci(this._val) && ei(this._units)) {
          ...
          for (const e in this._val) if (si(this._val[e])) {
            const s = this._val[e];
    ...
    class lo extends ki {
      ...
      get() {
        ...
        return Object.keys(t).forEach(e => {
          if (Reflect.has(this, e)) {
            const s = this[e];
            si(s) && si(s.value) && si(s.setValueAtTime) ? t[e] = s.value : s instanceof lo ? t[e] = s._getPartialProperties(t[e]) : ai(s) || ii(s) || ci(s) || ri(s) ? t[e] = s : delete t[e];
          }
        }), t;
      }
      ...
      set(t) {
        return Object.keys(t).forEach(e => {
          Reflect.has(this, e) && si(this[e]) && (this[e] && si(this[e].value) && si(this[e].setValueAtTime) ? this[e].value !== t[e] && (this[e].value = t[e]) : this[e] instanceof lo ? this[e].set(t[e]) : this[e] = t[e]);
        }), this;
      }
    ...
    class po extends Ei {
      ...
      setStateAtTime(t, e, s) {
        return Yn(e, 0), this.add(Object.assign({}, s, {
          state: t,
          time: e
        })), this;
      }
    ...
    class fo extends lo {
      constructor() {
        super(bi(fo.getDefaults(), arguments, ["param", "units", "convert"])), this.name = "Param", this.overridden = !1, this._minOutput = 1e-7;
        const t = bi(fo.getDefaults(), arguments, ["param", "units", "convert"]);

        for (Xn(si(t.param) && (_i(t.param) || t.param instanceof fo), "param must be an AudioParam"); !_i(t.param);) t.param = t.param._param;

        this._swappable = !!si(t.swappable) && t.swappable, this._swappable ? (this.input = this.context.createGain(), this._param = t.param, this.input.connect(this._param)) : this._param = this.input = t.param, this._events = new Ei(1e3), this._initialValue = this._param.defaultValue, this.units = t.units, this.convert = t.convert, this._minValue = t.minValue, this._maxValue = t.maxValue, si(t.value) && t.value !== this._toType(this._initialValue) && this.setValueAtTime(t.value, 0);
      }
      ...
      get minValue() {
        return si(this._minValue) ? this._minValue : "time" === this.units || "frequency" === this.units || "normalRange" === this.units || "positive" === this.units || "transportTime" === this.units || "ticks" === this.units || "bpm" === this.units || "hertz" === this.units || "samples" === this.units ? 0 : "audioRange" === this.units ? -1 : "decibels" === this.units ? -1 / 0 : this._param.minValue;
      }

      get maxValue() {
        return si(this._maxValue) ? this._maxValue : "normalRange" === this.units || "audioRange" === this.units ? 1 : this._param.maxValue;
      }
      ...
      _assertRange(t) {
        return si(this.maxValue) && si(this.minValue) && Yn(t, this._fromType(this.minValue), this._fromType(this.maxValue)), t;
      }

      _fromType(t) {
        return this.convert && !this.overridden ? this._is(t, "time") ? this.toSeconds(t) : this._is(t, "decibels") ? Yi(t) : this._is(t, "frequency") ? this.toFrequency(t) : t : this.overridden ? 0 : t;
      }
      ...
      setValueAtTime(t, e) {
        ...
        return Xn(isFinite(n) && isFinite(s), `Invalid argument(s) to setValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`), this._assertRange(n), this.log(this.units, "setValueAtTime", t, s), this._events.add({
          time: s,
          type: "setValueAtTime",
          value: n
      ...
      getValueAtTime(t) {
        ...
        if (null === n) i = this._initialValue;else if ("setTargetAtTime" !== n.type || null !== s && "setValueAtTime" !== s.type) {
          if (null === s) i = n.value;else if ("linearRampToValueAtTime" === s.type || "exponentialRampToValueAtTime" === s.type) {
            let t = n.value;
      ...
      linearRampToValueAtTime(t, e) {
        ...
        return Xn(isFinite(s) && isFinite(n), `Invalid argument(s) to linearRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`), this._assertRange(s), this._events.add({
          time: n,
      ...
      exponentialRampToValueAtTime(t, e) {
        ...
        return Xn(isFinite(s) && isFinite(n), `Invalid argument(s) to exponentialRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`), this._events.add({
          time: n,
      ...
      setTargetAtTime(t, e, s) {
        ...
        Xn(isFinite(s) && s > 0, "timeConstant must be a number greater than 0");
        const i = this.toSeconds(e);
        return this._assertRange(n), Xn(isFinite(n) && isFinite(i), `Invalid argument(s) to setTargetAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`), this._events.add({
          constant: s,
          time: i,
      ...
      cancelScheduledValues(t) {
        ...
        return Xn(isFinite(e), "Invalid argument to cancelScheduledValues: " + JSON.stringify(t)), this._events.cancel(e), this._param.cancelScheduledValues(e), this.log(this.units, "cancelScheduledValues", e), this;
      }
      ...
      setParam(t) {
        Xn(this._swappable, "The Param must be assigned as 'swappable' in the constructor");
        const e = this.input;
    ...
    class _o extends lo {
      ...
      get numberOfInputs() {
        return si(this.input) ? _i(this.input) || this.input instanceof fo ? 1 : this.input.numberOfInputs : 0;
      }
      ...
      dispose() {
        return super.dispose(), si(this.input) && (this.input instanceof _o ? this.input.dispose() : mi(this.input) && this.input.disconnect()), si(this.output) && (this.output instanceof _o ? this.output.dispose() : mi(this.output) && this.output.disconnect()), this._internalChannels = [], this;
      }
    ...
    function mo(...t) {
      const e = t.shift();
      t.reduce((t, e) => (t instanceof _o ? t.connect(e) : mi(t) && go(t, e), e), e);
    }

    function go(t, e, s = 0, n = 0) {
      for (Xn(si(t), "Cannot connect from undefined node"), Xn(si(e), "Cannot connect to undefined node"), (e instanceof _o || mi(e)) && Xn(e.numberOfInputs > 0, "Cannot connect to node with no inputs"), Xn(t.numberOfOutputs > 0, "Cannot connect from node with no outputs"); e instanceof _o || e instanceof fo;) si(e.input) && (e = e.input);
    ...
    function vo(t, e, s = 0, n = 0) {
      ...
      _i(e) ? t.disconnect(e, s) : mi(e) ? t.disconnect(e, s, n) : t.disconnect();
    }

    class yo extends _o {
      constructor() {
        super(bi(yo.getDefaults(), arguments, ["gain", "units"])), this.name = "Gain", this._gainNode = this.context.createGain(), this.input = this._gainNode, this.output = this._gainNode;
    ...
    class xo extends _o {
      constructor(t) {
        super(t), this.onended = zi, this._startTime = -1, this._stopTime = -1, this._timeout = -1, this.output = new yo({
          context: this.context,
          gain: 0
      ...
      _stopGain(t) {
        Xn(-1 !== this._startTime, "'start' must be called before 'stop'"), this.cancelStop();
      ...
      cancelStop() {
        return this.log("cancelStop"), Xn(-1 !== this._startTime, "Source is not started"), this._gainNode.gain.cancelScheduledValues(this._startTime + this.sampleTime), this.context.clearTimeout(this._timeout), this._stopTime = -1, this;
      }
    ...
    class wo extends xo {
      constructor() {
        super(bi(wo.getDefaults(), arguments, ["offset"])), this.name = "ToneConstantSource", this._source = this.context.createConstantSource();
        const t = bi(wo.getDefaults(), arguments, ["offset"]);
        go(this._source, this._gainNode), this.offset = new fo({
          context: this.context,
          convert: t.convert,
    ...
    class bo extends _o {
      constructor() {
        super(bi(bo.getDefaults(), arguments, ["value", "units"])), this.name = "Signal", this.override = !0;
    ...
    function To(t, e, s, n) {
      (e instanceof fo || _i(e) || e instanceof bo && e.override) && (e.cancelScheduledValues(0), e.setValueAtTime(0, 0), e instanceof bo && (e.overridden = !0)), go(t, e, s, n);
    }

    class So extends fo {
      constructor() {
        super(bi(So.getDefaults(), arguments, ["value"])), this.name = "TickParam", this._events = new Ei(1 / 0), this._multiplier = 1;
    ...
    class ko extends bo {
      constructor() {
        super(bi(ko.getDefaults(), arguments, ["value"])), this.name = "TickSignal";
    ...
    class Co extends lo {
      constructor() {
        super(bi(Co.getDefaults(), arguments, ["frequency"])), this.name = "TickSource", this._state = new po(), this._tickOffset = new Ei();
        const t = bi(Co.getDefaults(), arguments, ["frequency"]);
        this.frequency = new ko({
          context: this.context,
          units: t.units,
          value: t.frequency
        }), ji(this, "frequency"), this._state.setStateAtTime("stopped", 0), this.setTicksAtTime(0, 0);
      }
      ...
      start(t, e) {
        ...
        return "started" !== this._state.getValueAtTime(s) && (this._state.setStateAtTime("started", s), si(e) && this.setTicksAtTime(e, s)), this;
      }
    ...
    class Ao extends lo {
      constructor() {
        super(bi(Ao.getDefaults(), arguments, ["callback", "frequency"])), this.name = "Clock", this.callback = zi, this._lastUpdate = 0, this._state = new po("stopped"), this._boundLoop = this._loop.bind(this);
        const t = bi(Ao.getDefaults(), arguments, ["callback", "frequency"]);
        this.callback = t.callback, this._tickSource = new Co({
          context: this.context,
          frequency: t.frequency,
          units: t.units
        }), this._lastUpdate = 0, this.frequency = this._tickSource.frequency, ji(this, "frequency"), this._state.setStateAtTime("stopped", 0), this.context.on("tick", this._boundLoop);
      }
    ...
    class Do extends _o {
      constructor() {
        super(bi(Do.getDefaults(), arguments, ["delayTime", "maxDelay"])), this.name = "Delay";
        const t = bi(Do.getDefaults(), arguments, ["delayTime", "maxDelay"]),
              e = this.toSeconds(t.maxDelay);
        this._maxDelay = Math.max(e, this.toSeconds(t.delayTime)), this._delayNode = this.input = this.output = this.context.createDelay(e), this.delayTime = new fo({
          context: this.context,
    ...
    class Mo extends ki {
      constructor() {
        ...
        const t = bi(Mo.getDefaults(), arguments, ["urls", "onload", "baseUrl"], "urls");
      ...
      get(t) {
        return Xn(this.has(t), "ToneAudioBuffers has no buffer named: " + t), this._buffers.get(t.toString());
      }
      ...
      add(t, e, s = zi, n = zi) {
        return ci(e) ? this._buffers.set(t.toString(), new Bi(this.baseUrl + e, s, n)) : this._buffers.set(t.toString(), new Bi(e, s, n)), this;
      }
    ...
    class Io extends lo {
      constructor() {
        super(...arguments), this.name = "Draw", this.expiration = .25, this.anticipation = .008, this._events = new Ei(), this._boundDrawLoop = this._drawLoop.bind(this), this._animationFrame = -1;
      }
    ...
    class Vo extends ki {
      ...
      add(t) {
        Xn(si(t.time), "Events must have a time property"), Xn(si(t.duration), "Events must have a duration parameter"), t.time = t.time.valueOf();
      ...
      _removeNode(t) {
        if (null === t.left && null === t.right) this._replaceNodeInParent(t, null);else if (null === t.right) this._replaceNodeInParent(t, t.left);else if (null === t.left) this._replaceNodeInParent(t, t.right);else {
          let e,
              s = null;
          if (t.getBalance() > 0) {
            if (null === t.left.right) e = t.left, e.right = t.right, s = e;else {
    ...
    class Po extends _o {
      constructor() {
        super(bi(Po.getDefaults(), arguments, ["volume"])), this.name = "Volume";
        const t = bi(Po.getDefaults(), arguments, ["volume"]);
        this.input = this.output = new yo({
          context: this.context,
          gain: t.volume,
          units: "decibels"
        }), this.volume = this.output.gain, ji(this, "volume"), this._unmutedVolume = t.volume, this.mute = t.mute;
      }
    ...
    class jo extends _o {
      constructor() {
        super(bi(jo.getDefaults(), arguments)), this.name = "Destination", this.input = new Po({
          context: this.context
        }), this.output = new yo({
          context: this.context
        }), this.volume = this.input.volume;
        const t = bi(jo.getDefaults(), arguments);
        mo(this.input, this.output, this.context.rawContext.destination), this.mute = t.mute, this._internalChannels = [this.input, this.context.rawContext.destination, this.output];
      }
      ...
      chain(...t) {
        return this.input.disconnect(), t.unshift(this.input), t.push(this.output), mo(...t), this;
      }
    ...
    class Lo extends ki {
      constructor(t) {
        super(), this.name = "TimelineValue", this._timeline = new Ei({
          memory: 10
    ...
    class Bo extends zo {
      constructor(t, e) {
        ...
        this.duration = new qo(t.context, s.duration).valueOf(), this._interval = new qo(t.context, s.interval).valueOf(), this._nextTick = s.time, this.transport.on("start", this._boundRestart), this.transport.on("loopStart", this._boundRestart), this.context = this.transport.context, this._restart();
      }
      ...
      _createEvents(t) {
        ...
        e >= this.time && e >= this._nextTick && this._nextTick + this._interval < this.time + this.duration && (this._nextTick += this._interval, this._currentId = this._nextId, this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new qo(this.context, this._nextTick).toSeconds()));
      }

      _restart(t) {
        this.transport.clear(this._currentId), this.transport.clear(this._nextId), this._nextTick = this.time;
        const e = this.transport.getTicksAtTime(t);
        e > this.time && (this._nextTick = this.time + Math.ceil((e - this.time) / this._interval) * this._interval), this._currentId = this.transport.scheduleOnce(this.invoke.bind(this), new qo(this.context, this._nextTick).toSeconds()), this._nextTick += this._interval, this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new qo(this.context, this._nextTick).toSeconds());
      }
    ...
    class Wo extends lo {
      constructor() {
        super(bi(Wo.getDefaults(), arguments)), this.name = "Transport", this._loop = new Lo(!1), this._loopStart = 0, this._loopEnd = 0, this._scheduledEvents = {}, this._timeline = new Ei(), this._repeatedEvents = new Vo(), this._syncedSignals = [], this._swingAmount = 0;
        const t = bi(Wo.getDefaults(), arguments);
        this._ppq = t.ppq, this._clock = new Ao({
          callback: this._processTick.bind(this),
          context: this.context,
          frequency: 0,
          units: "bpm"
        }), this._bindClockEvents(), this.bpm = this._clock.frequency, this._clock.frequency.multiplier = t.ppq, this.bpm.setValueAtTime(t.bpm, 0), ji(this, "bpm"), this._timeSignature = t.timeSignature, this._swingTicks = t.ppq / 2;
      }
      ...
      _processTick(t, e) {
        if (this._swingAmount > 0 && e % this._ppq != 0 && e % (2 * this._swingTicks) != 0) {
          ...
          t += new qo(this.context, 2 * this._swingTicks / 3).toSeconds() * n;
        }
      ...
      dispose() {
        return super.dispose(), this._clock.dispose(), Li(this, "bpm"), this._timeline.dispose(), this._repeatedEvents.dispose(), this;
      }
    ...
    class Uo extends _o {
      constructor(t) {
        super(t), this.input = void 0, this._state = new po("stopped"), this._synced = !1, this._scheduled = [], this._syncedStart = zi, this._syncedStop = zi, this._state.memory = 100, this._state.increasing = !0, this._volume = this.output = new Po({
          context: this.context,
          mute: t.mute,
          volume: t.volume
        }), this.volume = this._volume.volume, ji(this, "volume"), this.onstop = t.onstop;
      }
      ...
      start(t, e, s) {
        let n = ei(t) && this._synced ? this.context.transport.seconds : this.toSeconds(t);
        if (n = this._clampToCurrentTime(n), this._synced || "started" !== this._state.getValueAtTime(n)) {
          if (this.log("start", n), this._state.setStateAtTime("started", n), this._synced) {
            ...
            t && (t.offset = this.toSeconds(Ti(e, 0)), t.duration = s ? this.toSeconds(s) : void 0);
        ...
        } else Xn(Ci(n, this._state.get(n).time), "Start time must be strictly greater than previous start time"), this._state.cancel(n), this._state.setStateAtTime("started", n), this.log("restart", n), this.restart(n, e, s);
        return this;
      }

      stop(t) {
        let e = ei(t) && this._synced ? this.context.transport.seconds : this.toSeconds(t);

        if (e = this._clampToCurrentTime(e), "started" === this._state.getValueAtTime(e) || si(this._state.getNextState("started", e))) {
    ...
    class Go extends xo {
      constructor() {
        super(bi(Go.getDefaults(), arguments, ["url", "onload"])), this.name = "ToneBufferSource", this._source = this.context.createBufferSource(), this._internalChannels = [this._source], this._sourceStarted = !1, this._sourceStopped = !1;
        const t = bi(Go.getDefaults(), arguments, ["url", "onload"]);
        go(this._source, this._gainNode), this._source.onended = () => this._stopSource(), this.playbackRate = new fo({
          context: this.context,
          param: this._source.playbackRate,
          units: "positive",
          value: t.playbackRate
        }), this.loop = t.loop, this.loopStart = t.loopStart, this.loopEnd = t.loopEnd, this._buffer = new Bi(t.url, t.onload, t.onerror), this._internalChannels.push(this._source);
      }
      ...
      start(t, e, s, n = 1) {
        ...
        this._startGain(i, n), e = this.loop ? Ti(e, this.loopStart) : Ti(e, 0);
        ...
        if (this.loop) {
          const t = this.toSeconds(this.loopEnd) || this.buffer.duration,
                ...
                s = t - e;
          Ai(o, t) && (o = (o - e) % s + e), Oi(o, this.buffer.duration) && (o = 0);
        }

        if (this._source.buffer = this.buffer.get(), this._source.loopEnd = this.toSeconds(this.loopEnd) || this.buffer.duration, Di(o, this.buffer.duration) && (this._sourceStarted = !0, this._source.start(i, o)), si(s)) {
    ...
    class Qo extends Uo {
      constructor() {
        super(bi(Qo.getDefaults(), arguments, ["type"])), this.name = "Noise", this._source = null;
      ...
      set type(t) {
        if (Xn(t in Xo, "Noise: invalid type: " + t), this._type !== t && (this._type = t, "started" === this.state)) {
          const t = this.now();
    ...
    class Yo extends _o {
      constructor() {
        super(bi(Yo.getDefaults(), arguments, ["volume"])), this.name = "UserMedia";
        const t = bi(Yo.getDefaults(), arguments, ["volume"]);
        this._volume = this.output = new Po({
          context: this.context,
          volume: t.volume
        }), this.volume = this._volume.volume, ji(this, "volume"), this.mute = t.mute;
      }
      ...
      open(t) {
        return di(this, void 0, void 0, function* () {
          Xn(Yo.supported, "UserMedia is not supported"), "started" === this.state && this.close();
          const e = yield Yo.enumerateDevices();
          ii(t) ? this._device = e[t] : (this._device = e.find(e => e.label === t || e.deviceId === t), !this._device && e.length > 0 && (this._device = e[0]), Xn(si(this._device), "No matching device " + t));
          const s = {
            audio: {
              echoCancellation: !1,
      ...
      static get supported() {
        return si(navigator.mediaDevices) && si(navigator.mediaDevices.getUserMedia);
      }
    ...
    class $o extends xo {
      constructor() {
        super(bi($o.getDefaults(), arguments, ["frequency", "type"])), this.name = "ToneOscillatorNode", this._oscillator = this.context.createOscillator(), this._internalChannels = [this._oscillator];
        const t = bi($o.getDefaults(), arguments, ["frequency", "type"]);
        go(this._oscillator, this._gainNode), this.type = t.type, this.frequency = new fo({
          context: this.context,
    ...
    class Jo extends Uo {
      constructor() {
        super(bi(Jo.getDefaults(), arguments, ["frequency", "type"])), this.name = "Oscillator", this._oscillator = null;
        const t = bi(Jo.getDefaults(), arguments, ["frequency", "type"]);
        this.frequency = new bo({
          context: this.context,
          units: "frequency",
          value: t.frequency
        }), ji(this, "frequency"), this.detune = new bo({
          context: this.context,
          units: "cents",
          value: t.detune
        }), ji(this, "detune"), this._partials = t.partials, this._partialCount = t.partialCount, this._type = t.type, t.partialCount && "custom" !== t.type && (this._type = this.baseType + t.partialCount.toString()), this.phase = t.phase;
      }
      ...
      _getCachedPeriodicWave() {
        ...
        {
          const t = Jo._periodicWaveCache.find(t => t.type === this._type && t.phase === this._phase);
      ...
      set type(t) {
        ...
        if (0 === this._phase && e) this._wave = void 0, this._partialCount = 0, null !== this._oscillator && (this._oscillator.type = t);else {
          ...
          if (si(e)) {
            ...
            this._wave = n, null !== this._oscillator && this._oscillator.setPeriodicWave(this._wave), Jo._periodicWaveCache.push({
              imag: s,
              ...
              type: this._type,
              wave: this._wave
            }), Jo._periodicWaveCache.length > 100 && Jo._periodicWaveCache.shift();
          }
        }
      }
    ...
    class tr extends Ko {
      constructor() {
        super(Object.assign(bi(tr.getDefaults(), arguments, ["mapping", "length"]))), this.name = "WaveShaper", this._shaper = this.context.createWaveShaper(), this.input = this._shaper, this.output = this._shaper;
        const t = bi(tr.getDefaults(), arguments, ["mapping", "length"]);
        ai(t.mapping) || t.mapping instanceof Float32Array ? this.curve = Float32Array.from(t.mapping) : ni(t.mapping) && this.setMap(t.mapping, t.length);
      }
      ...
      set oversample(t) {
        Xn(["none", "2x", "4x"].some(e => e.includes(t)), "oversampling must be either 'none', '2x', or '4x'"), this._shaper.oversample = t;
      }
    ...
    class er extends Ko {
      constructor() {
        super(...arguments), this.name = "AudioToGain", this._norm = new tr({
          context: this.context,
          mapping: t => (t + 1) / 2
    ...
    class sr extends bo {
      constructor() {
        super(Object.assign(bi(sr.getDefaults(), arguments, ["value"]))), this.name = "Multiply", this.override = !1;
    ...
    class nr extends Uo {
      constructor() {
        super(bi(nr.getDefaults(), arguments, ["frequency", "type", "modulationType"])), this.name = "AMOscillator", this._modulationScale = new er({
          context: this.context
        }), this._modulationNode = new yo({
          context: this.context
        });
        const t = bi(nr.getDefaults(), arguments, ["frequency", "type", "modulationType"]);
        this._carrier = new Jo({
          ...
          phase: t.phase,
          type: t.type
        }), this.frequency = this._carrier.frequency, this.detune = this._carrier.detune, this._modulator = new Jo({
          context: this.context,
          phase: t.phase,
          ...
          units: "positive",
          value: t.harmonicity
        }), this.frequency.chain(this.harmonicity, this._modulator.frequency), this._modulator.chain(this._modulationScale, this._modulationNode.gain), this._carrier.chain(this._modulationNode, this.output), ji(this, ["frequency", "detune", "harmonicity"]);
      }
    ...
    class ir extends Uo {
      constructor() {
        super(bi(ir.getDefaults(), arguments, ["frequency", "type", "modulationType"])), this.name = "FMOscillator", this._modulationNode = new yo({
          context: this.context,
          gain: 0
        });
        const t = bi(ir.getDefaults(), arguments, ["frequency", "type", "modulationType"]);
        this._carrier = new Jo({
          context: this.context,
          detune: t.detune,
          frequency: 0,
          ...
          phase: t.phase,
          type: t.type
        }), this.detune = this._carrier.detune, this.frequency = new bo({
          context: this.context,
          units: "frequency",
          value: t.frequency
    ...
    class or extends Uo {
      constructor() {
        super(bi(or.getDefaults(), arguments, ["frequency", "width"])), this.name = "PulseOscillator", this._widthGate = new yo({
          context: this.context,
          gain: 0
        }), this._thresh = new tr({
          context: this.context,
        ...
        this.width = new bo({
          ...
          phase: t.phase,
          type: "triangle"
        }), this.frequency = this._triangle.frequency, this.detune = this._triangle.detune, this._triangle.chain(this._thresh, this.output), this.width.chain(this._widthGate, this._thresh), ji(this, ["width", "frequency", "detune"]);
      }
    ...
    class rr extends Uo {
      constructor() {
        super(bi(rr.getDefaults(), arguments, ["frequency", "type", "spread"])), this.name = "FatOscillator", this._oscillators = [];
        const t = bi(rr.getDefaults(), arguments, ["frequency", "type", "spread"]);
        this.frequency = new bo({
          context: this.context,
          units: "frequency",
          value: t.frequency
          ...
          units: "cents",
          value: t.detune
        }), this._spread = t.spread, this._type = t.type, this._phase = t.phase, this._partials = t.partials, this._partialCount = t.partialCount, this.count = t.count, ji(this, ["frequency", "detune"]);
      }
    ...
    class ar extends Uo {
      constructor() {
        super(bi(ar.getDefaults(), arguments, ["frequency", "modulationFrequency"])), this.name = "PWMOscillator", this.sourceType = "pwm", this._scale = new sr({
          context: this.context,
          value: 2
        });
        const t = bi(ar.getDefaults(), arguments, ["frequency", "modulationFrequency"]);
        this._pulse = new or({
          context: this.context,
          frequency: t.modulationFrequency
        }), this._pulse.carrierType = "sine", this.modulationFrequency = this._pulse.frequency, this._modulator = new Jo({
          context: this.context,
          detune: t.detune,
          frequency: t.frequency,
          onstop: () => this.onstop(this),
          phase: t.phase
        }), this.frequency = this._modulator.frequency, this.detune = this._modulator.detune, this._modulator.chain(this._scale, this._pulse.width), this._pulse.connect(this.output), ji(this, ["modulationFrequency", "frequency", "detune"]);
      }
    ...
    class hr extends Uo {
      constructor() {
        super(bi(hr.getDefaults(), arguments, ["frequency", "type"])), this.name = "OmniOscillator";
        ...
        this.frequency = new bo({
          ...
          units: "cents",
          value: t.detune
        }), ji(this, ["frequency", "detune"]), this.set(t);
      }

      static getDefaults() {
        return Object.assign(Jo.getDefaults(), ir.getDefaults(), nr.getDefaults(), rr.getDefaults(), or.getDefaults(), ar.getDefaults());
      }
      ...
      set count(t) {
        this._getOscType(this._oscillator, "fat") && ii(t) && (this._oscillator.count = t);
      }
      ...
      set spread(t) {
        this._getOscType(this._oscillator, "fat") && ii(t) && (this._oscillator.spread = t);
      }
      ...
      set modulationType(t) {
        (this._getOscType(this._oscillator, "fm") || this._getOscType(this._oscillator, "am")) && ci(t) && (this._oscillator.modulationType = t);
      }
    ...
    class ur extends bo {
      constructor() {
        super(Object.assign(bi(ur.getDefaults(), arguments, ["value"]))), this.override = !1, this.name = "Add", this._sum = new yo({
          context: this.context
        }), this.input = this._sum, this.output = this._sum, this.addend = this._param, mo(this._constantSource, this._sum);
      }
    ...
    class lr extends Ko {
      constructor() {
        super(Object.assign(bi(lr.getDefaults(), arguments, ["min", "max"]))), this.name = "Scale";
      ...
      static getDefaults() {
        return Object.assign(Ko.getDefaults(), {
          max: 1,
          min: 0
        });
      }
    ...
    class pr extends Ko {
      constructor() {
        super(Object.assign(bi(pr.getDefaults(), arguments))), this.name = "Zero", this._gain = new yo({
          context: this.context
        }), this.output = this._gain, this.input = void 0, go(this.context.getConstant(0), this._gain);
      }
    ...
    class dr extends _o {
      constructor() {
        super(bi(dr.getDefaults(), arguments, ["frequency", "min", "max"])), this.name = "LFO", this._stoppedValue = 0, this._units = "number", this.convert = !0, this._fromType = fo.prototype._fromType, this._toType = fo.prototype._toType, this._is = fo.prototype._is, this._clampValue = fo.prototype._clampValue;
        const t = bi(dr.getDefaults(), arguments, ["frequency", "min", "max"]);
        this._oscillator = new Jo({
          context: this.context,
          frequency: t.frequency,
          type: t.type
        }), this.frequency = this._oscillator.frequency, this._amplitudeGain = new yo({
          context: this.context,
          gain: t.amplitude,
          units: "normalRange"
        }), this.amplitude = this._amplitudeGain.gain, this._stoppedSignal = new bo({
          context: this.context,
          units: "audioRange",
          value: 0
        }), this._zeros = new pr({
          ...
          max: t.max,
          min: t.min
        }), this.units = t.units, this.min = t.min, this.max = t.max, this._oscillator.chain(this._a2g, this._amplitudeGain, this._scaler), this._zeros.connect(this._a2g), this._stoppedSignal.connect(this._a2g), ji(this, ["amplitude", "frequency"]), this.phase = t.phase;
      }
      ...
      connect(t, e, s) {
        return (t instanceof fo || t instanceof bo) && (this.convert = t.convert, this.units = t.units), To(this, t, e, s), this;
      }
    ...
    class mr extends Uo {
      constructor() {
        super(bi(mr.getDefaults(), arguments, ["url", "onload"])), this.name = "Player", this._activeSources = new Set();
      ...
      _start(t, e, s) {
        ...
        this._loop || this._synced || (this._state.cancel(t + o), this._state.setStateAtTime("stopped", t + o, {
          implicitEnd: !0
        })), this._activeSources.add(r), this._loop && ei(i) ? r.start(t, n) : r.start(t, n, o - this.toSeconds(this.fadeOut));
      }
      ...
      set loopStart(t) {
        this._loopStart = t, this.buffer.loaded && Yn(this.toSeconds(t), 0, this.buffer.duration), this._activeSources.forEach(e => {
          e.loopStart = t;
        });
      }
      ...
      set loopEnd(t) {
        this._loopEnd = t, this.buffer.loaded && Yn(this.toSeconds(t), 0, this.buffer.duration), this._activeSources.forEach(e => {
          e.loopEnd = t;
        });
      }
    ...
    pi([_r(0)], mr.prototype, "fadeIn", void 0), pi([_r(0)], mr.prototype, "fadeOut", void 0);

    class gr extends _o {
      constructor() {
        super(bi(gr.getDefaults(), arguments, ["urls", "onload"], "urls")), this.name = "Players", this.input = void 0, this._players = new Map();
        const t = bi(gr.getDefaults(), arguments, ["urls", "onload"], "urls");
        this._volume = this.output = new Po({
          context: this.context,
          volume: t.volume
        }), this.volume = this._volume.volume, ji(this, "volume"), this._buffers = new Mo({
          urls: t.urls,
          onload: t.onload,
          baseUrl: t.baseUrl,
          onerror: t.onerror
      ...
      player(t) {
        if (Xn(this.has(t), `No Player with the name ${t} exists on this object`), !this._players.has(t)) {
          const e = new mr({
            context: this.context,
            fadeIn: this._fadeIn,
            fadeOut: this._fadeOut,
      ...
      add(t, e, s) {
        return Xn(!this._buffers.has(t), "A buffer with that name already exists on this object"), this._buffers.add(t, e, s), this;
      }
    ...
    class vr extends Uo {
      constructor() {
        super(bi(vr.getDefaults(), arguments, ["url", "onload"])), this.name = "GrainPlayer", this._loopStart = 0, this._loopEnd = 0, this._activeSources = [];
      ...
      set playbackRate(t) {
        Yn(t, .001), this._playbackRate = t, this.grainSize = this._grainSize;
      }
      ...
      set loopStart(t) {
        this.buffer.loaded && Yn(this.toSeconds(t), 0, this.buffer.duration), this._loopStart = this.toSeconds(t);
      }
      ...
      set loopEnd(t) {
        this.buffer.loaded && Yn(this.toSeconds(t), 0, this.buffer.duration), this._loopEnd = this.toSeconds(t);
      }
    ...
    class yr extends Ko {
      constructor() {
        super(...arguments), this.name = "Abs", this._abs = new tr({
          context: this.context,
    ...
    class xr extends Ko {
      constructor() {
        super(...arguments), this.name = "GainToAudio", this._norm = new tr({
          context: this.context,
    ...
    class wr extends Ko {
      constructor() {
        super(...arguments), this.name = "Negate", this._multiply = new sr({
          context: this.context,
          value: -1
    ...
    class br extends bo {
      constructor() {
        super(Object.assign(bi(br.getDefaults(), arguments, ["value"]))), this.override = !1, this.name = "Subtract", this._sum = new yo({
          context: this.context
        }), this.input = this._sum, this.output = this._sum, this._neg = new wr({
          context: this.context
        }), this.subtrahend = this._param, mo(this._constantSource, this._neg, this._sum);
      }
    ...
    class Tr extends Ko {
      constructor() {
        super(Object.assign(bi(Tr.getDefaults(), arguments))), this.name = "GreaterThanZero", this._thresh = this.output = new tr({
          context: this.context,
          length: 127,
          mapping: t => t <= 0 ? 0 : 1
    ...
    class Sr extends bo {
      constructor() {
        super(Object.assign(bi(Sr.getDefaults(), arguments, ["value"]))), this.name = "GreaterThan", this.override = !1;
        const t = bi(Sr.getDefaults(), arguments, ["value"]);
        this._subtract = this.input = new br({
          context: this.context,
          value: t.value
        }), this._gtz = this.output = new Tr({
          context: this.context
        }), this.comparator = this._param = this._subtract.subtrahend, ji(this, "comparator"), this._subtract.connect(this._gtz);
      }
    ...
    class kr extends Ko {
      constructor() {
        super(Object.assign(bi(kr.getDefaults(), arguments, ["value"]))), this.name = "Pow";
    ...
    class Cr extends lr {
      constructor() {
        super(Object.assign(bi(Cr.getDefaults(), arguments, ["min", "max", "exponent"]))), this.name = "ScaleExp";
    ...
    class Ar extends bo {
      constructor() {
        super(bi(bo.getDefaults(), arguments, ["value", "units"])), this.name = "SyncedSignal", this.override = !1;
        const t = bi(bo.getDefaults(), arguments, ["value", "units"]);
        this._lastVal = t.value, this._synced = this.context.transport.scheduleRepeat(this._onTick.bind(this), "1i"), this._syncedCallback = this._anchorValue.bind(this), this.context.transport.on("start", this._syncedCallback), this.context.transport.on("pause", this._syncedCallback), this.context.transport.on("stop", this._syncedCallback), this._constantSource.disconnect(), this._constantSource.stop(0), this._constantSource = this.output = new wo({
          context: this.context,
          offset: t.value,
          units: t.units
    ...
    class Dr extends _o {
      constructor() {
        super(bi(Dr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])), this.name = "Envelope", this._sig = new bo({
          context: this.context,
          value: 0
        }), this.output = this._sig, this.input = void 0;
        const t = bi(Dr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"]);
      ...
      _setCurve(t, e, s) {
        if (ci(s) && Reflect.has(Or, s)) {
          ...
          if (!ai(s) || "_decayCurve" === t) throw new Error("Envelope: invalid curve: " + s);
          this[t] = s;
        }
      }
      ...
      set decayCurve(t) {
        Xn(["linear", "exponential"].some(e => e === t), "Invalid envelope curve: " + t), this._decayCurve = t;
      }
      ...
      triggerAttack(t, e = 1) {
        ...
        if (s < this.sampleTime) this._sig.cancelScheduledValues(t), this._sig.setValueAtTime(e, t);else if ("linear" === this._attackCurve) this._sig.linearRampTo(e, s, t);else if ("exponential" === this._attackCurve) this._sig.targetRampTo(e, s, t);else {
      ...
      triggerRelease(t) {
        ...
        if (e > 0) {
          ...
          s < this.sampleTime ? this._sig.setValueAtTime(0, t) : "linear" === this._releaseCurve ? this._sig.linearRampTo(0, s, t) : "exponential" === this._releaseCurve ? this._sig.targetRampTo(0, s, t) : (Xn(ai(this._releaseCurve), "releaseCurve must be either 'linear', 'exponential' or an array"), this._sig.cancelAndHoldAtTime(t), this._sig.setValueCurveAtTime(this._releaseCurve, t, s, e));
        }
    ...
    pi([_r(0)], Dr.prototype, "attack", void 0), pi([_r(0)], Dr.prototype, "decay", void 0), pi([fr(0, 1)], Dr.prototype, "sustain", void 0), pi([_r(0)], Dr.prototype, "release", void 0);
    ...
    class Mr extends _o {
      constructor() {
        super(bi(Mr.getDefaults(), arguments)), this._scheduledEvents = [], this._synced = !1, this._original_triggerAttack = this.triggerAttack, this._original_triggerRelease = this.triggerRelease;
        const t = bi(Mr.getDefaults(), arguments);
        this._volume = this.output = new Po({
          context: this.context,
          volume: t.volume
        }), this.volume = this._volume.volume, ji(this, "volume");
      }
    ...
    class Rr extends Dr {
      constructor() {
        super(bi(Rr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])), this.name = "AmplitudeEnvelope", this._gainNode = new yo({
          context: this.context,
          gain: 0
    ...
    class qr extends Er {
      constructor() {
        ...
        this.oscillator = new hr(Object.assign({
          context: this.context,
          detune: t.detune,
          onstop: () => this.onsilence(this)
        }, t.oscillator)), this.frequency = this.oscillator.frequency, this.detune = this.oscillator.detune, this.envelope = new Rr(Object.assign({
          context: this.context
        }, t.envelope)), this.oscillator.chain(this.envelope, this.output), ji(this, ["oscillator", "frequency", "detune", "envelope"]);
      }

      static getDefaults() {
        return Object.assign(Er.getDefaults(), {
          envelope: Object.assign(Si(Dr.getDefaults(), Object.keys(_o.getDefaults())), {
            attack: .005,
            decay: .1,
            release: 1,
            sustain: .3
          }),
          oscillator: Object.assign(Si(hr.getDefaults(), [...Object.keys(Uo.getDefaults()), "frequency", "detune"]), {
            type: "triangle"
          })
        });
      }
    ...
    class Fr extends Er {
      constructor() {
        super(bi(Fr.getDefaults(), arguments)), this.name = "ModulationSynth";
        ...
        this._carrier = new qr({
          ...
          volume: -10
        }), this.oscillator = this._carrier.oscillator, this.envelope = this._carrier.envelope, this.modulation = this._modulator.oscillator, this.modulationEnvelope = this._modulator.envelope, this.frequency = new bo({
          context: this.context,
          units: "frequency"
        }), this.detune = new bo({
          context: this.context,
          ...
          context: this.context,
          gain: 0
        }), ji(this, ["frequency", "harmonicity", "oscillator", "envelope", "modulation", "modulationEnvelope", "detune"]);
      }
      ...
      static getDefaults() {
        return Object.assign(Er.getDefaults(), {
          ...
          modulation: Object.assign(Si(hr.getDefaults(), [...Object.keys(Uo.getDefaults()), "frequency", "detune"]), {
            type: "square"
          }),
          modulationEnvelope: Object.assign(Si(Dr.getDefaults(), Object.keys(_o.getDefaults())), {
            attack: .5,
            decay: 0,
            sustain: 1,
            release: .5
    ...
    class Ir extends Fr {
      constructor() {
        super(bi(Ir.getDefaults(), arguments)), this.name = "AMSynth", this._modulationScale = new er({
          context: this.context
    ...
    class Vr extends _o {
      constructor() {
        super(bi(Vr.getDefaults(), arguments, ["frequency", "type"])), this.name = "BiquadFilter";
        const t = bi(Vr.getDefaults(), arguments, ["frequency", "type"]);
        this._filter = this.context.createBiquadFilter(), this.input = this.output = this._filter, this.Q = new fo({
          context: this.context,
          units: "number",
          value: t.Q,
      ...
      set type(t) {
        Xn(-1 !== ["lowpass", "highpass", "bandpass", "lowshelf", "highshelf", "notch", "allpass", "peaking"].indexOf(t), "Invalid filter type: " + t), this._filter.type = t;
      }
    ...
    class Nr extends _o {
      constructor() {
        super(bi(Nr.getDefaults(), arguments, ["frequency", "type", "rolloff"])), this.name = "Filter", this.input = new yo({
          context: this.context
        }), this.output = new yo({
          context: this.context
        }), this._filters = [];
        const t = bi(Nr.getDefaults(), arguments, ["frequency", "type", "rolloff"]);
        this._filters = [], this.Q = new bo({
          context: this.context,
          units: "positive",
          value: t.Q
        }), this.frequency = new bo({
          ...
          units: "decibels",
          value: t.gain
        }), this._type = t.type, this.rolloff = t.rolloff, ji(this, ["detune", "frequency", "gain", "Q"]);
      }
      ...
      set type(t) {
        Xn(-1 !== ["lowpass", "highpass", "bandpass", "lowshelf", "highshelf", "notch", "allpass", "peaking"].indexOf(t), "Invalid filter type: " + t), this._type = t, this._filters.forEach(e => e.type = t);
      }
      ...
      set rolloff(t) {
        const e = ii(t) ? t : parseInt(t, 10),
              s = [-12, -24, -48, -96];
        let n = s.indexOf(e);
        Xn(-1 !== n, "rolloff can only be " + s.join(", ")), n += 1, this._rolloff = e, this.input.disconnect(), this._filters.forEach(t => t.disconnect()), this._filters = new Array(n);
        ...
        this._internalChannels = this._filters, mo(this.input, ...this._internalChannels, this.output);
      }
      ...
      dispose() {
        return super.dispose(), this._filters.forEach(t => {
          t.dispose();
        }), Li(this, ["detune", "frequency", "gain", "Q"]), this.frequency.dispose(), this.Q.dispose(), this.detune.dispose(), this.gain.dispose(), this;
      }
    ...
    class Pr extends Dr {
      constructor() {
        super(bi(Pr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])), this.name = "FrequencyEnvelope";
        const t = bi(Pr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"]);
        this._octaves = t.octaves, this._baseFrequency = this.toFrequency(t.baseFrequency), this._exponent = this.input = new kr({
          context: this.context,
          value: t.exponent
      ...
      set baseFrequency(t) {
        ...
        Yn(e, 0), this._baseFrequency = e, this._scale.min = this._baseFrequency, this.octaves = this._octaves;
      }
      ...
      set octaves(t) {
        Yn(t, 0), this._octaves = t, this._scale.max = this._baseFrequency * Math.pow(2, t);
      }
    ...
    class jr extends Er {
      constructor() {
        ...
        this.oscillator = new hr(Object.assign(t.oscillator, {
          context: this.context,
          detune: t.detune,
          onstop: () => this.onsilence(this)
        })), this.frequency = this.oscillator.frequency, this.detune = this.oscillator.detune, this.filter = new Nr(Object.assign(t.filter, {
          context: this.context
        })), this.filterEnvelope = new Pr(Object.assign(t.filterEnvelope, {
          context: this.context
        })), this.envelope = new Rr(Object.assign(t.envelope, {
          context: this.context
        })), this.oscillator.chain(this.filter, this.envelope, this.output), this.filterEnvelope.connect(this.filter.frequency), ji(this, ["oscillator", "frequency", "detune", "filter", "filterEnvelope", "envelope"]);
      }
      ...
      static getDefaults() {
        return Object.assign(Er.getDefaults(), {
          ...
          filter: Object.assign(Si(Nr.getDefaults(), Object.keys(_o.getDefaults())), {
            Q: 1,
            rolloff: -12,
            type: "lowpass"
          }),
          filterEnvelope: Object.assign(Si(Pr.getDefaults(), Object.keys(_o.getDefaults())), {
            attack: .6,
            baseFrequency: 200,
            decay: .2,
            exponent: 2,
          ...
          oscillator: Object.assign(Si(hr.getDefaults(), Object.keys(Uo.getDefaults())), {
            type: "sawtooth"
          })
        });
      }
    ...
    class Lr extends Er {
      constructor() {
        ...
        this.voice0 = new jr(Object.assign(t.voice0, {
          context: this.context,
          onsilence: () => this.onsilence(this)
        })), this.voice1 = new jr(Object.assign(t.voice1, {
          context: this.context
        })), this.harmonicity = new sr({
          context: this.context,
          units: "positive",
          ...
          min: -50,
          max: 50
        }), this._vibrato.start(), this.vibratoRate = this._vibrato.frequency, this._vibratoGain = new yo({
          context: this.context,
          units: "normalRange",
          gain: t.vibratoAmount
        }), this.vibratoAmount = this._vibratoGain.gain, this.frequency = new bo({
          context: this.context,
          units: "frequency",
          value: 440
        }), this.detune = new bo({
          ...
          units: "cents",
          value: t.detune
        }), this.frequency.connect(this.voice0.frequency), this.frequency.chain(this.harmonicity, this.voice1.frequency), this._vibrato.connect(this._vibratoGain), this._vibratoGain.fan(this.voice0.detune, this.voice1.detune), this.detune.fan(this.voice0.detune, this.voice1.detune), this.voice0.connect(this.output), this.voice1.connect(this.output), ji(this, ["voice0", "voice1", "frequency", "vibratoAmount", "vibratoRate"]);
      }
    ...
    class Wr extends Er {
      constructor() {
        super(bi(Wr.getDefaults(), arguments)), this.name = "MetalSynth", this._oscillators = [], this._freqMultipliers = [];
        ...
        this.detune = new bo({
          ...
          context: this.context,
          gain: 0
        }).connect(this.output), this._highpass = new Nr({
          Q: 0,
          context: this.context,
          type: "highpass"
    ...
    class Ur extends qr {
      constructor() {
        super(bi(Ur.getDefaults(), arguments)), this.name = "MembraneSynth", this.portamento = 0;
        const t = bi(Ur.getDefaults(), arguments);
        this.pitchDecay = t.pitchDecay, this.octaves = t.octaves, ji(this, ["oscillator", "envelope"]);
      }
    ...
    pi([fr(0)], Ur.prototype, "octaves", void 0), pi([_r(0)], Ur.prototype, "pitchDecay", void 0);

    class Gr extends Mr {
      constructor() {
        super(bi(Gr.getDefaults(), arguments)), this.name = "NoiseSynth";
        const t = bi(Gr.getDefaults(), arguments);
        this.noise = new Qo(Object.assign({
          context: this.context
        }, t.noise)), this.envelope = new Rr(Object.assign({
          context: this.context
      ...
      static getDefaults() {
        return Object.assign(Mr.getDefaults(), {
          ...
          noise: Object.assign(Si(Qo.getDefaults(), Object.keys(Uo.getDefaults())), {
            type: "white"
          })
        });
      }
    ...
    class Yr extends _o {
      constructor(t) {
        super(t), this.name = "ToneAudioWorklet", this.workletOptions = {}, this.onprocessorerror = zi;

        const e = URL.createObjectURL(new Blob([Array.from(Qr).join("\n")], {
          type: "text/javascript"
        })),
    ...
    class Hr extends Yr {
      constructor() {
        super(bi(Hr.getDefaults(), arguments, ["delayTime", "resonance"])), this.name = "FeedbackCombFilter";
    ...
    class $r extends _o {
      constructor() {
        super(bi($r.getDefaults(), arguments, ["frequency", "type"])), this.name = "OnePoleFilter";
        const t = bi($r.getDefaults(), arguments, ["frequency", "type"]);
        this._frequency = t.frequency, this._type = t.type, this.input = new yo({
          context: this.context
        }), this.output = new yo({
          context: this.context
        }), this._createFilter();
    ...
    class Jr extends _o {
      constructor() {
        super(bi(Jr.getDefaults(), arguments, ["delayTime", "resonance", "dampening"])), this.name = "LowpassCombFilter";
        const t = bi(Jr.getDefaults(), arguments, ["delayTime", "resonance", "dampening"]);
        this._combFilter = this.output = new Hr({
          context: this.context,
          delayTime: t.delayTime,
          resonance: t.resonance
        }), this.delayTime = this._combFilter.delayTime, this.resonance = this._combFilter.resonance, this._lowpass = this.input = new $r({
          context: this.context,
    ...
    class Kr extends Mr {
      constructor() {
        ...
        this._noise = new Qo({
          context: this.context,
          type: "pink"
        }), this.attackNoise = t.attackNoise, this._lfcf = new Jr({
          context: this.context,
    ...
    class ta extends Mr {
      constructor() {
        super(bi(ta.getDefaults(), arguments, ["voice", "options"])), this.name = "PolySynth", this._availableVoices = [], this._activeVoices = [], this._voices = [], this._gcTimeout = -1, this._averageActiveVoices = 0;
        const t = bi(ta.getDefaults(), arguments, ["voice", "options"]);
        Xn(!ii(t.voice), "DEPRECATED: The polyphony count is no longer the first argument.");
      ...
      _scheduleEvent(t, e, s, n) {
        Xn(!this.disposed, "Synth was already disposed"), s <= this.now() ? "attack" === t ? this._triggerAttack(e, s, n) : this._triggerRelease(e, s) : this.context.setTimeout(() => {
      ...
      triggerAttackRelease(t, e, s, n) {
        ...
        if (this.triggerAttack(t, i, n), ai(e)) {
          Xn(ai(t), "If the duration is an array, the notes must also be an array"), t = t;

          for (let s = 0; s < t.length; s++) {
            const n = e[Math.min(s, e.length - 1)],
                  o = this.toSeconds(n);
            Xn(o > 0, "The duration must be greater than 0"), this.triggerRelease(t[s], i + o);
          }
        } else {
          const s = this.toSeconds(e);
          Xn(s > 0, "The duration must be greater than 0"), this.triggerRelease(t, i + s);
        }
      ...
      set(t) {
        ...
        return this.options = wi(this.options, e), this._voices.forEach(t => t.set(e)), this._dummyVoice.set(e), this;
      }
    ...
    class ea extends Mr {
      constructor() {
        super(bi(ea.getDefaults(), arguments, ["urls", "onload", "baseUrl"], "urls")), this.name = "Sampler", this._activeSources = new Map();
        const t = bi(ea.getDefaults(), arguments, ["urls", "onload", "baseUrl"], "urls"),
              e = {};
        Object.keys(t.urls).forEach(s => {
          const n = parseInt(s, 10);

          if (Xn(hi(s) || ii(n) && isFinite(n), "url key is neither a note or midi pitch: " + s), hi(s)) {
      ...
      triggerAttack(t, e, s = 1) {
        return this.log("triggerAttack", t, e, s), Array.isArray(t) || (t = [t]), t.forEach(t => {
          ...
          u.start(e, 0, c.duration / h, s), ai(this._activeSources.get(i)) || this._activeSources.set(i, []), this._activeSources.get(i).push(u), u.onended = () => {
      ...
      triggerAttackRelease(t, e, s, n = 1) {
        const i = this.toSeconds(s);
        return this.triggerAttack(t, i, n), ai(e) ? (Xn(ai(t), "notes must be an array when duration is array"), t.forEach((t, s) => {
          const n = e[Math.min(s, e.length - 1)];
      ...
      add(t, e, s) {
        if (Xn(hi(t) || isFinite(t), "note must be a pitch or midi: " + t), hi(t)) {
    ...
    pi([_r(0)], ea.prototype, "attack", void 0), pi([_r(0)], ea.prototype, "release", void 0);

    class sa extends lo {
      constructor() {
        super(bi(sa.getDefaults(), arguments, ["callback", "value"])), this.name = "ToneEvent", this._state = new po("stopped"), this._startOffset = 0;
        ...
        this._state.forEachFrom(t, t => {
          ...
          if ("started" === t.state) {
            ...
            if (!0 === this._loop || ii(this._loop) && this._loop > 1) {
              e = 1 / 0, ii(this._loop) && (e = this._loop * this._getLoopDuration());

              const n = this._state.getAfter(s);

              null !== n && (e = Math.min(e, n.time - s)), e !== 1 / 0 && (this._state.setStateAtTime("stopped", s + e + 1, {
                id: -1
              }), e = new qo(this.context, e));
              const i = new qo(this.context, this._getLoopDuration());
              t.id = this.context.transport.scheduleRepeat(this._tick.bind(this), i, new qo(this.context, s), e);
            } else t.id = this.context.transport.schedule(this._tick.bind(this), new qo(this.context, s));
          }
        });
      }
      ...
      _tick(t) {
        ...
        if (!this.mute && "started" === this._state.getValueAtTime(e)) {
          ...
          if (this.humanize) {
            let e = .02;
            ri(this.humanize) || (e = this.toSeconds(this.humanize)), t += (2 * Math.random() - 1) * e;
          }
    ...
    class na extends lo {
      constructor() {
        super(bi(na.getDefaults(), arguments, ["callback", "interval"])), this.name = "Loop";
    ...
    class ia extends sa {
      constructor() {
        super(bi(ia.getDefaults(), arguments, ["callback", "events"])), this.name = "Part", this._state = new po("stopped"), this._events = new Set();
      ...
      start(t, e) {
        ...
        if ("started" !== this._state.getValueAtTime(s)) {
          e = Ti(e, this._loop ? this._loopStart : 0), e = this._loop ? Ti(e, this._loopStart) : Ti(e, 0);
      ...
      _startNote(t, e, s) {
        e -= s, this._loop ? t.startOffset >= this._loopStart && t.startOffset < this._loopEnd ? (t.startOffset < s && (e += this._getLoopDuration()), t.start(new qo(this.context, e))) : t.startOffset < this._loopStart && t.startOffset >= s && (t.loop = !1, t.start(new qo(this.context, e))) : t.startOffset >= s && t.start(new qo(this.context, e));
      }
      ...
      at(t, e) {
        ...
        for (; !o.done;) {
          const t = o.value;
          if (Math.abs(s - t.startOffset) < n) return si(e) && (t.value = e), t;
          o = i.next();
        }
      ...
      add(t, e) {
        ...
        const s = this.toTicks(t);
        let n;
        return e instanceof sa ? (n = e, n.callback = this._tick.bind(this)) : n = new sa({
          callback: this._tick.bind(this),
          context: this.context,
          value: e
      ...
      _restartEvent(t) {
        this._state.forEach(e => {
          "started" === e.state ? this._startNote(t, e.time, e.offset) : t.stop(new qo(this.context, e.time));
        });
      }

      remove(t, e) {
        return oi(t) && t.hasOwnProperty("time") && (t = (e = t).time), t = this.toTicks(t), this._events.forEach(s => {
          s.startOffset === t && (ei(e) || si(e) && s.value === e) && (this._events.delete(s), s.dispose());
        }), this;
      }
    ...
    function* ha(t, e) {
      ...
      for (;;) s = ca(s, t), yield t[s], e ? (s++, s >= t.length - 1 && (e = !1)) : (s--, s <= 0 && (e = !0));
    }
    ...
    function* ua(t) {
      ...
      for (; e < t.length;) e = ca(e, t), yield t[e], s++, e += s % 2 ? 2 : -1;
    }
    ...
    function* da(t, e = "up", s = 0) {
      switch (Xn(t.length > 0, "The array must have more than one value in it"), e) {
        case "up":
          yield* aa(t, oa);
    ...
    class fa extends na {
      constructor() {
        super(bi(fa.getDefaults(), arguments, ["callback", "values", "pattern"])), this.name = "Pattern";
        const t = bi(fa.getDefaults(), arguments, ["callback", "values", "pattern"]);
        this.callback = t.callback, this._values = t.values, this._pattern = da(t.values, t.pattern), this._type = t.pattern;
      }
    ...
    class _a extends sa {
      constructor() {
        super(bi(_a.getDefaults(), arguments, ["callback", "events", "subdivision"])), this.name = "Sequence", this._part = new ia({
          callback: this._seqCallback.bind(this),
          context: this.context
        }), this._events = [], this._eventsArray = [];
        const t = bi(_a.getDefaults(), arguments, ["callback", "events", "subdivision"]);
      ...
      _createSequence(t) {
        return new Proxy(t, {
          get: (t, e) => t[e],
          set: (t, e, s) => (ci(e) && isFinite(parseInt(e, 10)) && ai(s) ? t[e] = this._createSequence(s) : t[e] = s, this._eventsUpdated(), !0)
        });
      }
      ...
      _rescheduleSequence(t, e, s) {
        t.forEach((t, n) => {
          const i = n * e + s;
          if (ai(t)) this._rescheduleSequence(t, e / t.length, i);else {
      ...
      _indexTime(t) {
        return new qo(this.context, t * this._subdivision + this.startOffset).toSeconds();
      }
    ...
    class ma extends _o {
      constructor() {
        super(Object.assign(bi(ma.getDefaults(), arguments, ["fade"]))), this.name = "CrossFade", this._panner = this.context.createStereoPanner(), this._split = this.context.createChannelSplitter(2), this._g2a = new xr({
          context: this.context
        }), this.a = new yo({
          context: this.context,
          gain: 0
    ...
    class ga extends _o {
      constructor(t) {
        super(t), this.name = "Effect", this._dryWet = new ma({
          context: this.context
        }), this.wet = this._dryWet.fade, this.effectSend = new yo({
          context: this.context
        }), this.effectReturn = new yo({
          context: this.context
        }), this.input = new yo({
          context: this.context
        }), this.output = this._dryWet, this.input.fan(this._dryWet.a, this.effectSend), this.effectReturn.connect(this._dryWet.b), this.wet.setValueAtTime(t.wet, 0), this._internalChannels = [this.effectReturn, this.effectSend], ji(this, "wet");
      }
    ...
    class va extends ga {
      constructor(t) {
        super(t), this.name = "LFOEffect", this._lfo = new dr({
          context: this.context,
          frequency: t.frequency,
          amplitude: t.depth
        }), this.depth = this._lfo.amplitude, this.frequency = this._lfo.frequency, this.type = t.type, ji(this, ["frequency", "depth"]);
      }
    ...
    class ya extends va {
      constructor() {
        super(bi(ya.getDefaults(), arguments, ["frequency", "baseFrequency", "octaves"])), this.name = "AutoFilter";
        const t = bi(ya.getDefaults(), arguments, ["frequency", "baseFrequency", "octaves"]);
        this.filter = new Nr(Object.assign(t.filter, {
          context: this.context
    ...
    class xa extends _o {
      constructor() {
        super(Object.assign(bi(xa.getDefaults(), arguments, ["pan"]))), this.name = "Panner", this._panner = this.context.createStereoPanner(), this.input = this._panner, this.output = this._panner;
        ...
        this.pan = new fo({
          ...
          minValue: -1,
          maxValue: 1
        }), this._panner.channelCount = t.channelCount, this._panner.channelCountMode = "explicit", ji(this, "pan");
      }
    ...
    class wa extends va {
      constructor() {
        super(bi(wa.getDefaults(), arguments, ["frequency"])), this.name = "AutoPanner";
    ...
    class ba extends _o {
      constructor() {
        super(bi(ba.getDefaults(), arguments, ["smoothing"])), this.name = "Follower";
        const t = bi(ba.getDefaults(), arguments, ["smoothing"]);
        this._abs = this.input = new yr({
          context: this.context
    ...
    class Ta extends ga {
      constructor() {
        super(bi(Ta.getDefaults(), arguments, ["baseFrequency", "octaves", "sensitivity"])), this.name = "AutoWah";
        const t = bi(Ta.getDefaults(), arguments, ["baseFrequency", "octaves", "sensitivity"]);
        this._follower = new ba({
          ...
          max: 1,
          exponent: .5
        }), this._baseFrequency = this.toFrequency(t.baseFrequency), this._octaves = t.octaves, this._inputBoost = new yo({
          context: this.context
    ...
    class Sa extends ga {
      constructor() {
        super(bi(Sa.getDefaults(), arguments, ["bits"])), this.name = "BitCrusher";
    ...
    class ka extends Yr {
      constructor() {
        super(bi(ka.getDefaults(), arguments)), this.name = "BitCrusherWorklet";
    ...
    class Ca extends ga {
      constructor() {
        super(bi(Ca.getDefaults(), arguments, ["order"])), this.name = "Chebyshev";
    ...
    class Aa extends _o {
      constructor() {
        super(bi(Aa.getDefaults(), arguments, ["channels"])), this.name = "Split";
    ...
    class Da extends _o {
      constructor() {
        super(bi(Da.getDefaults(), arguments, ["channels"])), this.name = "Merge";
    ...
    class Oa extends _o {
      constructor(t) {
        super(t), this.name = "StereoEffect", this.input = new yo({
          context: this.context
        }), this.input.channelCount = 2, this.input.channelCountMode = "explicit", this._dryWet = this.output = new ma({
          context: this.context,
          fade: t.wet
          ...
          context: this.context,
          channels: 2
        }), this.input.connect(this._split), this.input.connect(this._dryWet.a), this._merge.connect(this._dryWet.b), ji(this, ["wet"]);
      }

      connectEffectLeft(...t) {
        this._split.connect(t[0], 0, 0), mo(...t), go(t[t.length - 1], this._merge, 0, 0);
      }

      connectEffectRight(...t) {
        this._split.connect(t[0], 1, 0), mo(...t), go(t[t.length - 1], this._merge, 0, 1);
      }
    ...
    class Ma extends Oa {
      constructor(t) {
        super(t), this.feedback = new bo({
          context: this.context,
          value: t.feedback,
          units: "normalRange"
        }), this._feedbackL = new yo({
          context: this.context
        }), this._feedbackR = new yo({
          context: this.context
          ...
          context: this.context,
          channels: 2
        }), this._merge.connect(this._feedbackSplit), this._feedbackMerge.connect(this._split), this._feedbackSplit.connect(this._feedbackL, 0, 0), this._feedbackL.connect(this._feedbackMerge, 0, 0), this._feedbackSplit.connect(this._feedbackR, 1, 0), this._feedbackR.connect(this._feedbackMerge, 0, 1), this.feedback.fan(this._feedbackL.gain, this._feedbackR.gain), ji(this, ["feedback"]);
      }
    ...
    class Ea extends Ma {
      constructor() {
        super(bi(Ea.getDefaults(), arguments, ["frequency", "delayTime", "depth"])), this.name = "Chorus";
        const t = bi(Ea.getDefaults(), arguments, ["frequency", "delayTime", "depth"]);
        this._depth = t.depth, this._delayTime = t.delayTime / 1e3, this._lfoL = new dr({
          context: this.context,
          frequency: t.frequency,
          min: 0,
          max: 1
          ...
          max: 1,
          phase: 180
        }), this._delayNodeL = new Do({
          context: this.context
        }), this._delayNodeR = new Do({
          context: this.context
        }), this.frequency = this._lfoL.frequency, ji(this, ["frequency"]), this._lfoL.frequency.connect(this._lfoR.frequency), this.connectEffectLeft(this._delayNodeL), this.connectEffectRight(this._delayNodeR), this._lfoL.connect(this._delayNodeL.delayTime), this._lfoR.connect(this._delayNodeR.delayTime), this.depth = this._depth, this.type = t.type, this.spread = t.spread;
      }
    ...
    class Ra extends ga {
      constructor() {
        super(bi(Ra.getDefaults(), arguments, ["distortion"])), this.name = "Distortion";
    ...
    class qa extends ga {
      constructor(t) {
        super(t), this.name = "FeedbackEffect", this._feedbackGain = new yo({
          context: this.context,
          gain: t.feedback,
          units: "normalRange"
        }), this.feedback = this._feedbackGain.gain, ji(this, "feedback"), this.effectReturn.chain(this._feedbackGain, this.effectSend);
      }
    ...
    class Fa extends qa {
      constructor() {
        super(bi(Fa.getDefaults(), arguments, ["delayTime", "feedback"])), this.name = "FeedbackDelay";
        const t = bi(Fa.getDefaults(), arguments, ["delayTime", "feedback"]);
        this._delayNode = new Do({
          context: this.context,
          delayTime: t.delayTime,
          maxDelay: t.maxDelay
        }), this.delayTime = this._delayNode.delayTime, this.connectEffect(this._delayNode), ji(this, "delayTime");
      }
    ...
    class Ia extends _o {
      constructor(t) {
        super(t), this.name = "PhaseShiftAllpass", this.input = new yo({
          context: this.context
        }), this.output = new yo({
          context: this.context
        }), this.offset90 = new yo({
          context: this.context
        });
        this._bank0 = this._createAllPassFilterBank([.6923878, .9360654322959, .988229522686, .9987488452737]), this._bank1 = this._createAllPassFilterBank([.4021921162426, .856171088242, .9722909545651, .9952884791278]), this._oneSampleDelay = this.context.createIIRFilter([0, 1], [1, 0]), mo(this.input, ...this._bank0, this._oneSampleDelay, this.output), mo(this.input, ...this._bank1, this.offset90);
      }
    ...
    class Va extends ga {
      constructor() {
        super(bi(Va.getDefaults(), arguments, ["frequency"])), this.name = "FrequencyShifter";
        ...
        this.frequency = new bo({
          ...
          phase: -90,
          type: "sine"
        }), this._sineMultiply = new sr({
          context: this.context
        }), this._cosineMultiply = new sr({
          context: this.context
        }), this._negate = new wr({
          context: this.context
        }), this._add = new ur({
          context: this.context
        }), this._phaseShifter = new Ia({
          context: this.context
    ...
    const Na = [1557 / 44100, 1617 / 44100, 1491 / 44100, 1422 / 44100, 1277 / 44100, 1356 / 44100, 1188 / 44100, 1116 / 44100],
          Pa = [225, 556, 441, 341];

    class ja extends Oa {
      constructor() {
        super(bi(ja.getDefaults(), arguments, ["roomSize", "dampening"])), this.name = "Freeverb", this._combFilters = [], this._allpassFiltersL = [], this._allpassFiltersR = [];
        ...
        this.roomSize = new bo({
          ...
          return s < Na.length / 2 ? this.connectEffectLeft(n, ...this._allpassFiltersL) : this.connectEffectRight(n, ...this._allpassFiltersR), this.roomSize.connect(n.resonance), n;
        }), ji(this, ["roomSize"]);
      }
    ...
    const La = [.06748, .06404, .08212, .09004],
          za = [.773, .802, .753, .733],
          Ba = [347, 113, 37];

    class Wa extends Oa {
      constructor() {
        super(bi(Wa.getDefaults(), arguments, ["roomSize"])), this.name = "JCReverb", this._allpassFilters = [], this._feedbackCombFilters = [];
        ...
        this.roomSize = new bo({
          ...
          return this._scaleRoomSize.connect(s.resonance), s.resonance.value = za[e], e < La.length / 2 ? this.connectEffectLeft(...this._allpassFilters, s) : this.connectEffectRight(...this._allpassFilters, s), s;
        }), this.roomSize.connect(this._scaleRoomSize), ji(this, ["roomSize"]);
      }
    ...
    class Ua extends Ma {
      constructor(t) {
        super(t), this._feedbackL.disconnect(), this._feedbackL.connect(this._feedbackMerge, 0, 1), this._feedbackR.disconnect(), this._feedbackR.connect(this._feedbackMerge, 0, 0), ji(this, ["feedback"]);
      }
    ...
    class Ga extends Ua {
      constructor() {
        super(bi(Ga.getDefaults(), arguments, ["delayTime", "feedback"])), this.name = "PingPongDelay";
        ...
        this._leftDelay = new Do({
          ...
          units: "time",
          value: t.delayTime
        }), this.connectEffectLeft(this._leftDelay), this.connectEffectRight(this._rightPreDelay, this._rightDelay), this.delayTime.fan(this._leftDelay.delayTime, this._rightDelay.delayTime, this._rightPreDelay.delayTime), this._feedbackL.disconnect(), this._feedbackL.connect(this._rightDelay), ji(this, ["delayTime"]);
      }
    ...
    class Qa extends qa {
      constructor() {
        super(bi(Qa.getDefaults(), arguments, ["pitch"])), this.name = "PitchShift";
        const t = bi(Qa.getDefaults(), arguments, ["pitch"]);
        this._frequency = new bo({
          context: this.context
        }), this._delayA = new Do({
          maxDelay: 1,
          context: this.context
          ...
          max: .1,
          type: "sawtooth"
        }).connect(this._delayA.delayTime), this._delayB = new Do({
          maxDelay: 1,
          context: this.context
        }), this._lfoB = new dr({
          context: this.context,
          ...
          type: "sawtooth",
          phase: 180
        }).connect(this._delayB.delayTime), this._crossFade = new ma({
          context: this.context
          ...
          type: "triangle",
          phase: 90
        }).connect(this._crossFade.fade), this._feedbackDelay = new Do({
          delayTime: t.delayTime,
          context: this.context
        }), this.delayTime = this._feedbackDelay.delayTime, ji(this, "delayTime"), this._pitch = t.pitch, this._windowSize = t.windowSize, this._delayA.connect(this._crossFade.a), this._delayB.connect(this._crossFade.b), this._frequency.fan(this._lfoA.frequency, this._lfoB.frequency, this._crossFadeLFO.frequency), this.effectSend.fan(this._delayA, this._delayB), this._crossFade.chain(this._feedbackDelay, this.effectReturn);
        const e = this.now();
      ...
      set pitch(t) {
        this._pitch = t;
        let e = 0;
        t < 0 ? (this._lfoA.min = 0, this._lfoA.max = this._windowSize, this._lfoB.min = 0, this._lfoB.max = this._windowSize, e = $i(t - 1) + 1) : (this._lfoA.min = this._windowSize, this._lfoA.max = 0, this._lfoB.min = this._windowSize, this._lfoB.max = 0, e = $i(t) - 1), this._frequency.value = e * (1.2 / this._windowSize);
      }
    ...
    class Za extends Oa {
      constructor() {
        super(bi(Za.getDefaults(), arguments, ["frequency", "octaves", "baseFrequency"])), this.name = "Phaser";
        const t = bi(Za.getDefaults(), arguments, ["frequency", "octaves", "baseFrequency"]);
        this._lfoL = new dr({
          context: this.context,
          frequency: t.frequency,
          min: 0,
          ...
          max: 1,
          phase: 180
        }), this._baseFrequency = this.toFrequency(t.baseFrequency), this._octaves = t.octaves, this.Q = new bo({
          context: this.context,
          value: t.Q,
          units: "positive"
        }), this._filtersL = this._makeFilters(t.stages, this._lfoL), this._filtersR = this._makeFilters(t.stages, this._lfoR), this.frequency = this._lfoL.frequency, this.frequency.value = t.frequency, this.connectEffectLeft(...this._filtersL), this.connectEffectRight(...this._filtersR), this._lfoL.frequency.connect(this._lfoR.frequency), this.baseFrequency = t.baseFrequency, this.octaves = t.octaves, this._lfoL.start(), this._lfoR.start(), ji(this, ["frequency", "Q"]);
      }
    ...
    class Xa extends ga {
      constructor() {
        super(bi(Xa.getDefaults(), arguments, ["decay"])), this.name = "Reverb", this._convolver = this.context.createConvolver(), this.ready = Promise.resolve();
      ...
      set decay(t) {
        Yn(t = this.toSeconds(t), .001), this._decay = t, this.generate();
      }
      ...
      generate() {
        return di(this, void 0, void 0, function* () {
          const t = this.ready,
                e = new Wi(2, this._decay + this._preDelay, this.context.sampleRate),
                s = new Qo({
            context: e
          }),
                n = new Qo({
          ...
          const r = e.render();
          return this.ready = r.then(zi), yield t, this._convolver.buffer = (yield r).get(), this;
        });
      }
    ...
    class Ya extends _o {
      constructor() {
        super(bi(Ya.getDefaults(), arguments)), this.name = "MidSideSplit", this._split = this.input = new Aa({
          channels: 2,
          context: this.context
        }), this._midAdd = new ur({
          context: this.context
    ...
    class Ha extends _o {
      constructor() {
        super(bi(Ha.getDefaults(), arguments)), this.name = "MidSideMerge", this.mid = new yo({
          context: this.context
        }), this.side = new yo({
          context: this.context
        }), this._left = new ur({
          ...
          context: this.context,
          value: Math.SQRT1_2
        }), this._merge = this.output = new Da({
          context: this.context
    ...
    class $a extends ga {
      constructor(t) {
        super(t), this.name = "MidSideEffect", this._midSideMerge = new Ha({
          context: this.context
        }), this._midSideSplit = new Ya({
          context: this.context
    ...
    class Ja extends $a {
      constructor() {
        super(bi(Ja.getDefaults(), arguments, ["width"])), this.name = "StereoWidener";
        const t = bi(Ja.getDefaults(), arguments, ["width"]);
        this.width = new bo({
          context: this.context,
          value: t.width,
          units: "normalRange"
        }), ji(this, ["width"]), this._twoTimesWidthMid = new sr({
          context: this.context,
          value: 2
        }), this._twoTimesWidthSide = new sr({
          context: this.context,
          value: 2
        }), this._midMult = new sr({
          context: this.context
        }), this._twoTimesWidthMid.connect(this._midMult.factor), this.connectEffectMid(this._midMult), this._oneMinusWidth = new br({
          context: this.context
        }), this._oneMinusWidth.connect(this._twoTimesWidthMid), go(this.context.getConstant(1), this._oneMinusWidth), this.width.connect(this._oneMinusWidth.subtrahend), this._sideMult = new sr({
          context: this.context
    ...
    class Ka extends Oa {
      constructor() {
        super(bi(Ka.getDefaults(), arguments, ["frequency", "depth"])), this.name = "Tremolo";
        ...
        this._lfoL = new dr({
          ...
          min: 1,
          max: 0
        }), this._amplitudeL = new yo({
          context: this.context
        }), this._amplitudeR = new yo({
          context: this.context
        }), this.frequency = new bo({
          context: this.context,
          value: t.frequency,
          ...
          value: t.depth,
          units: "normalRange"
        }), ji(this, ["frequency", "depth"]), this.connectEffectLeft(this._amplitudeL), this.connectEffectRight(this._amplitudeR), this._lfoL.connect(this._amplitudeL.gain), this._lfoR.connect(this._amplitudeR.gain), this.frequency.fan(this._lfoL.frequency, this._lfoR.frequency), this.depth.fan(this._lfoR.amplitude, this._lfoL.amplitude), this.spread = t.spread;
      }
    ...
    class tc extends ga {
      constructor() {
        super(bi(tc.getDefaults(), arguments, ["frequency", "depth"])), this.name = "Vibrato";
        ...
        this._delayNode = new Do({
          ...
          frequency: t.frequency,
          phase: -90
        }).start().connect(this._delayNode.delayTime), this.frequency = this._lfo.frequency, this.depth = this._lfo.amplitude, this.depth.value = t.depth, ji(this, ["frequency", "depth"]), this.effectSend.chain(this._delayNode, this.effectReturn);
      }
    ...
    class ec extends _o {
      constructor() {
        super(bi(ec.getDefaults(), arguments, ["type", "size"])), this.name = "Analyser", this._analysers = [], this._buffers = [];
        ...
        this.input = this.output = this._gain = new yo({
          ...
          context: this.context,
          channels: t.channels
        }), this.input.connect(this._split), Yn(t.channels, 1);
      ...
      set type(t) {
        Xn("waveform" === t || "fft" === t, "Analyser: invalid type: " + t), this._type = t;
      }
    ...
    class sc extends _o {
      constructor() {
        super(bi(sc.getDefaults(), arguments)), this.name = "MeterBase", this.input = this.output = this._analyser = new ec({
          context: this.context,
          size: 256,
          type: "waveform"
        });
    ...
    class nc extends sc {
      constructor() {
        super(bi(nc.getDefaults(), arguments, ["smoothing"])), this.name = "Meter", this._rms = 0;
      ...
      getValue() {
        const t = this._analyser.getValue(),
          ...
          return this._rms = Math.max(s, this._rms * this.smoothing), this.normalRange ? this._rms : Hi(this._rms);
        });
    ...
    class ic extends sc {
      ...
      getValue() {
        return this._analyser.getValue().map(t => this.normalRange ? Yi(t) : t);
      }
      ...
      getFrequencyOfIndex(t) {
        return Xn(0 <= t && t < this.size, "index must be greater than or equal to 0 and less than " + this.size), t * this.context.sampleRate / (2 * this.size);
      }
    ...
    class oc extends sc {
      constructor() {
        super(bi(oc.getDefaults(), arguments)), this.name = "DCMeter", this._analyser.type = "waveform", this._analyser.size = 256;
      }
    ...
    class rc extends sc {
      constructor() {
        super(bi(rc.getDefaults(), arguments, ["size"])), this.name = "Waveform";
    ...
    class ac extends _o {
      constructor() {
        super(bi(ac.getDefaults(), arguments, ["solo"])), this.name = "Solo";
        const t = bi(ac.getDefaults(), arguments, ["solo"]);
        this.input = this.output = new yo({
          context: this.context
        }), ac._allSolos.has(this.context) || ac._allSolos.set(this.context, new Set()), ac._allSolos.get(this.context).add(this), this.solo = t.solo;
      }
      ...
      set solo(t) {
        t ? this._addSolo() : this._removeSolo(), ac._allSolos.get(this.context).forEach(t => t._updateSolo());
      }
      ...
      _addSolo() {
        ac._soloed.has(this.context) || ac._soloed.set(this.context, new Set()), ac._soloed.get(this.context).add(this);
      }

      _removeSolo() {
        ac._soloed.has(this.context) && ac._soloed.get(this.context).delete(this);
      }

      _isSoloed() {
        return ac._soloed.has(this.context) && ac._soloed.get(this.context).has(this);
      }

      _noSolos() {
        return !ac._soloed.has(this.context) || ac._soloed.has(this.context) && 0 === ac._soloed.get(this.context).size;
      }
      ...
      dispose() {
        return super.dispose(), ac._allSolos.get(this.context).delete(this), this._removeSolo(), this;
      }
    ...
    class cc extends _o {
      constructor() {
        super(bi(cc.getDefaults(), arguments, ["pan", "volume"])), this.name = "PanVol";
        const t = bi(cc.getDefaults(), arguments, ["pan", "volume"]);
        this._panner = this.input = new xa({
          context: this.context,
          pan: t.pan,
          channelCount: t.channelCount
        }), this.pan = this._panner.pan, this._volume = this.output = new Po({
          context: this.context,
          volume: t.volume
        }), this.volume = this._volume.volume, this._panner.connect(this._volume), this.mute = t.mute, ji(this, ["pan", "volume"]);
      }
    ...
    class hc extends _o {
      constructor() {
        super(bi(hc.getDefaults(), arguments, ["volume", "pan"])), this.name = "Channel";
        ...
        this._solo = this.input = new ac({
          ...
          mute: t.mute,
          channelCount: t.channelCount
        }), this.pan = this._panVol.pan, this.volume = this._panVol.volume, this._solo.connect(this._panVol), ji(this, ["pan", "volume"]);
      }
      ...
      _getBus(t) {
        return hc.buses.has(t) || hc.buses.set(t, new yo({
          context: this.context
        })), hc.buses.get(t);
      }
    ...
    class uc extends _o {
      constructor() {
        super(bi(uc.getDefaults(), arguments, ["lowFrequency", "highFrequency"])), this.name = "MultibandSplit", this.input = new yo({
          context: this.context
        }), this.output = void 0, this.low = new Nr({
          context: this.context,
          frequency: 0,
          type: "lowpass"
        ...
        const t = bi(uc.getDefaults(), arguments, ["lowFrequency", "highFrequency"]);
      ...
      dispose() {
        return super.dispose(), Li(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]), this.low.dispose(), this._lowMidFilter.dispose(), this.mid.dispose(), this.high.dispose(), this.lowFrequency.dispose(), this.highFrequency.dispose(), this.Q.dispose(), this;
      }
    ...
    class lc extends _o {
      constructor() {
        super(...arguments), this.name = "Listener", this.positionX = new fo({
          context: this.context,
    ...
    class pc extends _o {
      constructor() {
        super(bi(pc.getDefaults(), arguments, ["positionX", "positionY", "positionZ"])), this.name = "Panner3D";
        const t = bi(pc.getDefaults(), arguments, ["positionX", "positionY", "positionZ"]);
        this._panner = this.input = this.output = this.context.createPanner(), this.panningModel = t.panningModel, this.maxDistance = t.maxDistance, this.distanceModel = t.distanceModel, this.coneOuterGain = t.coneOuterGain, this.coneOuterAngle = t.coneOuterAngle, this.coneInnerAngle = t.coneInnerAngle, this.refDistance = t.refDistance, this.rolloffFactor = t.rolloffFactor, this.positionX = new fo({
          context: this.context,
    ...
    class dc extends _o {
      constructor() {
        ...
        this.input = new yo({
          context: this.context
        }), Xn(dc.supported, "Media Recorder API is not available"), this._stream = this.context.createMediaStreamDestination(), this.input.connect(this._stream), this._recorder = new MediaRecorder(this._stream.stream, {
          mimeType: t.mimeType
        });
      }
      ...
      pause() {
        return Xn("started" === this.state, "Recorder must be started"), this._recorder.pause(), this;
      }
    ...
    class fc extends _o {
      constructor() {
        super(bi(fc.getDefaults(), arguments, ["threshold", "ratio"])), this.name = "Compressor", this._compressor = this.context.createDynamicsCompressor(), this.input = this._compressor, this.output = this._compressor;
    ...
    class _c extends _o {
      constructor() {
        super(Object.assign(bi(_c.getDefaults(), arguments, ["threshold", "smoothing"]))), this.name = "Gate";
    ...
    class mc extends _o {
      constructor() {
        super(Object.assign(bi(mc.getDefaults(), arguments, ["threshold"]))), this.name = "Limiter";
        ...
        }), this.threshold = this._compressor.threshold, ji(this, "threshold");
      }
    ...
    class gc extends _o {
      constructor() {
        super(Object.assign(bi(gc.getDefaults(), arguments))), this.name = "MidSideCompressor";
        const t = bi(gc.getDefaults(), arguments);
        this._midSideSplit = this.input = new Ya({
          context: this.context
        }), this._midSideMerge = this.output = new Ha({
          context: this.context
        }), this.mid = new fc(Object.assign(t.mid, {
          context: this.context
        })), this.side = new fc(Object.assign(t.side, {
          context: this.context
        })), this._midSideSplit.mid.chain(this.mid, this._midSideMerge.mid), this._midSideSplit.side.chain(this.side, this._midSideMerge.side), ji(this, ["mid", "side"]);
      }
    ...
    class vc extends _o {
      constructor() {
        super(Object.assign(bi(vc.getDefaults(), arguments))), this.name = "MultibandCompressor";
        ...
        }), this.lowFrequency = this._splitter.lowFrequency, this.highFrequency = this._splitter.highFrequency, this.output = new yo({
          context: this.context
        }), this.low = new fc(Object.assign(t.low, {
          context: this.context
        })), this.mid = new fc(Object.assign(t.mid, {
          context: this.context
        })), this.high = new fc(Object.assign(t.high, {
          context: this.context
        })), this._splitter.low.chain(this.low, this.output), this._splitter.mid.chain(this.mid, this.output), this._splitter.high.chain(this.high, this.output), ji(this, ["high", "mid", "low", "highFrequency", "lowFrequency"]);
      }
    ...
    class yc extends _o {
      constructor() {
        super(bi(yc.getDefaults(), arguments, ["low", "mid", "high"])), this.name = "EQ3", this.output = new yo({
          context: this.context
        ...
        this.input = this._multibandSplit = new uc({
          ...
          gain: t.high,
          units: "decibels"
        }), this.low = this._lowGain.gain, this.mid = this._midGain.gain, this.high = this._highGain.gain, this.Q = this._multibandSplit.Q, this.lowFrequency = this._multibandSplit.lowFrequency, this.highFrequency = this._multibandSplit.highFrequency, this._multibandSplit.low.chain(this._lowGain, this.output), this._multibandSplit.mid.chain(this._midGain, this.output), this._multibandSplit.high.chain(this._highGain, this.output), ji(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]), this._internalChannels = [this._multibandSplit];
      }
      ...
      dispose() {
        return super.dispose(), Li(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]), this._multibandSplit.dispose(), this.lowFrequency.dispose(), this.highFrequency.dispose(), this._lowGain.dispose(), this._midGain.dispose(), this._highGain.dispose(), this.low.dispose(), this.mid.dispose(), this.high.dispose(), this.Q.dispose(), this;
      }
    ...
    class xc extends _o {
      constructor() {
        super(bi(xc.getDefaults(), arguments, ["url", "onload"])), this.name = "Convolver", this._convolver = this.context.createConvolver();
...
},{}],"3zRkE":[function(require,module,exports) {
var define;
!function (t, e) {
...
},{}]},{},["2leY7","5Qp60"], "5Qp60", "parcelRequire1713")

//# sourceMappingURL=index.d52f1cb9.js.map
